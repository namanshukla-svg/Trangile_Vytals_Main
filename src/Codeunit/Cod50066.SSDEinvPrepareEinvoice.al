codeunit 50066 "SSDEinvPrepareEinvoice"
{
    trigger OnRun()
    begin
        Initialize();
    ...
    procedure EsportJsonTxt() JsonTxt: Text;
    var
    begin
        Initialize();
        if IsInvoice then
    ...
    var
        HeaderStringWriter: JsonObject;
    begin
        // StringWriter.Add('Version', '1.1');
        // StringWriter.Add('TaxSch', 'GST'); 
        // StringWriter.Add('IRN', ''); 
        StringWriter.Add('access_token', '');
        StringWriter.Add('user_gstin', GetGSTIN(SalesInvoiceHeader."Location Code"));
        StringWriter.Add('data_soure', 'erp');
    ...
    begin
        ...
        StringWriter.Add('transaction_details', TranDtlsWriter);
    end;
    ...
    begin
        ...
        StringWriter.Add('document_details', DocDtlsWriter);
    end;
    ...
    begin
        ...
        StringWriter.Add('export_details', ExpDtlsWtriter);
    end;
    ...
    local procedure WriteSellerDtls(Gstin: Text[15]; TrdNm: Text[100]; Bno: Text[60]; Bnm: Text[60]; Flno: Text[60]; Loc: Text[60]; Dst: Text[60]; Pin: Code[10]; Stcd: Text; Ph: Text[10]; Em: Text[50]; LegalName: text)
    var
    ...
    begin
        ...
        StringWriter.Add('seller_details', SellerDtlsWriter)
    end;
    ...
    local procedure WriteBuyerDtls(Gstin: Text[15]; TrdNm: Text[100]; Bno: Text[100]; Bnm: Text[100]; Flno: Text[60]; Loc: Text[60]; Dst: Text[60]; Pin: Code[20]; Stcd: Text; Ph: Text[10]; Em: Text[50]; POS: Text[2])
    var
    ...
    begin
        ...
        StringWriter.Add('buyer_details', BuyerDtlsWriter);
    end;

    local procedure WriteBuyerTransDtls(Gstin: Text[15]; TrdNm: Text[100]; Bno: Text[100]; Bnm: Text[100]; Flno: Text[60]; Loc: Text[60]; Dst: Text[60]; Pin: Code[20]; Stcd: Text; Ph: Text[10]; Em: Text[50]; POS: Text[2]; LegName: text[100])
    var
        BuyerDtlsWriter: JsonObject;
    begin
        BuyerDtlsWriter.Add('gstin', Gstin);
    ...
    local procedure WriteShipDtls(Gstin: Text[15]; TrdNm: Text[100]; Bno: Text[60]; Bnm: Text[60]; Flno: Text[60]; Loc: Text[60]; Dst: Text[60]; Pin: Code[10]; Stcd: Text; Ph: Text[10]; Em: Text[50])
    var
    ...
    begin
        ...
        StringWriter.Add('ship_details', ShipDtlsWriter);
    end;
    ...
    begin
        ...
        StringWriter.Add('value_details', ValDtlsWriter);
    end;
        ...
        if IsInvoice then begin
            ...
            if SalesInvoiceLine.FINDSET() then begin
                ...
                REPEAT
                    ...
                    ELSE
                        IsServc := 'N';
                    WriteItem(ItemDesc_GtextN, SalesInvoiceLine."HSN/SAC Code", SalesInvoiceLine.Quantity, FreeQty, UOM, SalesInvoiceLine."Unit Price", SalesInvoiceLine."Line Amount", SalesInvoiceLine."Line Discount Amount" + SalesInvoiceLine."Inv. Discount Amount", SalesInvoiceLine.Amount, AssAmt, GSTRt, CgstAmt, SgstAmt, IgstAmt, CesRt, CesAmt, CesNonAdval, StateCesRt, StateCesAmt, StateCesNonAdvlAmt, 0, SalesInvoiceLine.Amount + TotalGSTAmount, SalesInvoiceLine."Line No.", SlNo, IsServc);
                UNTIL SalesInvoiceLine.NEXT() = 0;
            END;
            StringWriter.Add('item_list', JsonArrayData);
        END
        ELSE begin
            SalesCrMemoLine.SETRANGE("Document No.", DocumentNo);
            ...
            if SalesCrMemoLine.FINDSET() then begin
                ...
                REPEAT
                    ...
                    ELSE
                        IsServc := 'N';
                    WriteItem(ItemDesc_GtextN, SalesCrMemoLine."HSN/SAC Code", SalesCrMemoLine.Quantity, FreeQty, UOM, SalesCrMemoLine."Unit Price", SalesCrMemoLine."Line Amount", SalesCrMemoLine."Line Discount Amount" + SalesCrMemoLine."Inv. Discount Amount", SalesCrMemoLine.Amount, AssAmt, GSTRt, CgstAmt, SgstAmt, IgstAmt, CesRt, CesAmt, CesNonAdval, StateCesRt, StateCesAmt, StateCesNonAdvlAmt, 0, SalesCrMemoLine.Amount + TotalGSTAmount, SalesCrMemoLine."Line No.", SlNo, IsServc);
                UNTIL SalesCrMemoLine.NEXT() = 0;
                StringWriter.Add('item_list', JsonArrayData);
            END;
        end;
    ...
    begin
        ...
        IF IsInvoice THEN BEGIN
            ...
            SalesInvoiceLine.SETFILTER("No.", '%1', '22045710');
            IF SalesInvoiceLine.FINDFIRST THEN
                REPEAT
                    RndOffAmt += SalesInvoiceLine."Line Amount";
                UNTIL SalesInvoiceLine.NEXT = 0;
            TotiInvValFc := TotLineAmt + TotGSTAmt - Disc + OthChrg;
            ...
            TotInvVal := TotLineAmt + TotGSTAmt - Disc + OthChrg;
        END
        ELSE BEGIN
            SalesCrMemoLine.SETRANGE("Document No.", DocumentNo);
            IF SalesCrMemoLine.FINDSET THEN BEGIN
            ...
            SalesCrMemoLine.SETFILTER("No.", '%1', '426013');
            IF SalesCrMemoLine.FINDFIRST THEN
                REPEAT
    ...
    begin
        ...
        StringWriter.WriteTo(JsonTxt);
    end;

    local procedure ExportTransferShipment()
    begin
        CLEAR(CurrExRate);
        IF TransShipHeader.FINDSET THEN //JsonTextWriter.WriteStartArray;
            REPEAT
                CurrExRate := 1;
                DocumentNo := TransShipHeader."No.";
                WriteFileHeader;
                WriteTransDtls('B2B', 'RG', '', 'false', 'Y', '', '', '');
                ReadTrfDocDtls;
                ReadTransferorDtls;
                ReadTransfereeDtls;
                // WriteDispDtls;
                ...
                // WriteRefDtls;
                //ReadExpDtls;
                IF EWBApplicable THEN ReadTransferEWBDtls;
    ...
    begin
        Typ := 'INV';
        Dt := FORMAT(TransShipHeader."Posting Date", 0, '<Day,2>/<Month,2>/<Year4>');
    ...
    begin
        if SalesInvoiceHeader.get(ReferenceNo) then begin
            ...
            StringWriter.Add('rdocument_period_details', RefDtlsWriter);
            StringWriter.Add('reference_details', RefDtlsWriter);
            RefDtlsWriter.Add('reference_of_original_invoice', ReferenceNo);
            RefDtlsWriter.Add('preceding_invoice_date', PosD);
            StringWriter.Add('preceding_document_details', RefDtlsWriter);
        end;
    end;
    //SSD
    ...
    begin
        ...
        // Temp Values only for Sandbox. To be removed for Go-Live
        // end;
        WriteSellerDtls(Gstin, TrdNm, Addr1, Addr2, '', '', Loc, Pin, Stcd, Ph, Em, '');
    end;
    ...
    begin
        ...
        END;
        //Gstin := '37AMBPG7773M002';
        Gstin := Stcd + COPYSTR(Gstin, 3, 13);
        WriteBuyerDtls(Gstin, TrdNm, Addr1, Addr2, '', '', Loc, Pin, Stcd, Ph, Em, POS);
    end;
    ...
    begin
        ...
        IF TransShipmentLine.FINDSET THEN BEGIN
            ...
            REPEAT
                ...
                CLEAR(UOM);
                //if UnitofMeasure.Get(TransShipmentLine."Unit of Measure Code") then
