Page 50050 "RGP outbound"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(RGPLines; "RGP outbound Subform")
            {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Re&lease")
                {
                    ...
                    trigger OnAction()
                    begin
                        //SSD Sunl Update workflow
                        //if Rec.Approved then begin
                        Rec.TestField("Shortcut Dimension 1 Code");
                        Rec.Approved := true;
                        Rec."Approval ID" := UserId;
                        Rec.Release;
                        //end else
                ...
                group("Request Approval")
                {
                    ...
                    action(SendApprovalRequest)
                    {
                        ...
                        begin
                            if UserSetup1.Get(UserId) then UserSetup1.TestField("NRGP Send For Approval");
                ...
                //                     if UserSetup1."RGP Send For Approval" then begin
