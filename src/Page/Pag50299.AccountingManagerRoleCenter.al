page 50299 "Accounting Manager RoleCenter"
{
    Caption = 'ZD Accounting Manager Role Center';
    PageType = RoleCenter;
    ApplicationArea = All;
    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Aged Accounts &Receivable New")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Aged Accounts &Receivable';
                Image = "Report";
                RunObject = Report "Aged Accounts Receivable New";
            ...
            // action("New Aged Accounts Receivable")
            // {
            //     ApplicationArea = Basic;
            //     Caption = 'New Aged Accounts Receivable';
            //     Image = "Report";
            //     RunObject = Report "AKS-Test-Report";
            // }
        ...
        area(embedding)
        {
            action("Request to Approve")
            {
                ...
                ToolTip = 'View the Request to Approve.';
            }
        ...
        area(sections)
        {
            group(Journals)
            {
                ...
                action("Cash Receipt Voucher")
                {
                    ...
                    Image = Journals;
                    RunObject = Page "General Journal Batches";
                    RunPageView = where("Template Type" = const(General), // "Sub Type" = const("Cash Receipt Voucher"),
                ...
                action("Bank Receipt Voucher")
                {
                    ...
                    Image = Journals;
                    RunObject = Page "General Journal Batches";
                    RunPageView = where("Template Type" = const(General), // "Sub Type" = const("Bank Receipt Voucher"),
                    Recurring = const(false));
                }
                ...
                action("Cash Payment Voucher")
                {
                    ...
                    Image = Journals;
                    RunObject = Page "General Journal Batches";
                    RunPageView = where("Template Type" = const(General), // "Sub Type" = const("Cash Payment Voucher"),
                    Recurring = const(false));
                }
                action("Bank Payment Voucher")
                {
                    ...
                    Image = Journals;
                    RunObject = Page "General Journal Batches";
                    RunPageView = where("Template Type" = const(General), // "Sub Type" = const("Bank Payment Voucher"),
                    Recurring = const(false));
                }
                ...
                action("General Voucher")
                {
                    ...
                    RunObject = Page "General Journal Batches";
                    RunPageView = where("Template Type" = const(General), // "Sub Type" = const("Journal Voucher"),
                    Recurring = const(false));
                }
                action("Contra Voucher")
                {
                    ...
                    RunObject = Page "General Journal Batches";
                    RunPageView = where("Template Type" = const(General), // "Sub Type" = const("Contra Voucher"),
                    Recurring = const(false));
                }
        ...
        area(processing)
        {
            ...
            action("Adjust E&xchange Rates")
            {
                ...
                RunObject = Report "Exch. Rate Adjustment";//IG_DS_before "Adjust Exchange Rates";
            }
            ...
            //     RunObject = Page UnknownPage16476;
            // }
            // action("VAT Settlement")
            // {
            //     ApplicationArea = Basic;
            //     Caption = 'VAT Settlement';
            //     RunObject = Page UnknownPage16542;
            // }
