Page 50159 "Edit P.Man. Q.Order Subform"
{
    Caption = 'Posted Manufacturing Quality Order Subform';
    DeleteAllowed = false;
    Editable = true;
    InsertAllowed = false;
    ModifyAllowed = true;
        ...
        area(processing)
        {
            group("&Order")
            {
                ...
                action("Line Comments")
                {
                    ...
                    trigger OnAction()
                    begin
                        //This functionality was copied from page #50158. Unsupported part was commented. Please check it.
