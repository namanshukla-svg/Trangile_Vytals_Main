Page 50170 "Get Posted NRGP Shipment"
{
    PageType = List;
    SourceTable = "SSD RGP Shipment Header";
    SourceTableView = where(NRGP=filter(true));
    ApplicationArea = All;
    ...
    begin
        ...
        if Rec.Find('-')then repeat //Alle-HB-15oct15 START
                ...
                if LRGPShipLine.FindSet then repeat if LItem.Get(LRGPShipLine."No.")then begin
                ...
                GatePassLine."Invoice Amount":=Rec."Freight Amount";
