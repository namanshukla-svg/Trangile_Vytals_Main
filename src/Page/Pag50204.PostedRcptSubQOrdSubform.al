Page 50204 "Posted Rcpt. Sub Q.Ord Subform"
{
    Caption = 'Posted Rcpt. Sub Quality Order Subform';
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    ModifyAllowed = false;
        ...
        area(processing)
        {
            group("&Order")
            {
                ...
                action("Line Comments")
                {
                    ...
                    trigger OnAction()
                    begin
                        //This functionality was copied from page #50203. Unsupported part was commented. Please check it.
