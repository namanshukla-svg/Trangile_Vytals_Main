tableextension 50074 "SSD Reservation Entry" extends "Reservation Entry"
{
    fields
    {
        ...
        {
            CalcFormula = lookup(Item."Responsibility Center" where("No." = field("Item No.")));
            Caption = 'Responsibility Center';
            Description = 'CF001';
            Editable = true;
            FieldClass = FlowField;
        }
        field(50005; "Copy Made For FG item Of PL"; Boolean)
        {
            Description = 'MFG-032 For Identify the entry is made manually for FG item';
            DataClassification = CustomerContent;
            Caption = 'Copy Made For FG item Of PL';
        }
        ...
        field(50071; "QR Scanned"; Boolean)
        {
            DataClassification = CustomerContent;
            Caption = 'QR Scanned';
        }
