Table 50083 "SSD Posted Quality Order Line"
{
    Caption = 'Posted Quality Order Line';
    ...
    fields
    {
        ...
        {
            Caption = 'Document No.';
            TableRelation = "SSD Posted Quality Order Hdr";
            DataClassification = CustomerContent;
        }
        ...
        field(70; "Initial Sample Value1"; Decimal)
        {
            ...
            begin
                ...
                "Actual Test Results Data":="Inspection Value2"; // Alle 050816
            //ALLE[5.51]
            end;
        }
        ...
        field(50016; "Approved By"; Text[30])
        {
            Description = 'ALLE SS';
            DataClassification = CustomerContent;
            Caption = 'Approved By';
    ...
    begin
        ...
        rQualityComent.SetRange(rQualityComent.TableId, Database::"SSD Posted Quality Order Line");
