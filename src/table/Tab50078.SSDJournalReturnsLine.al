Table 50078 "SSD Journal Returns Line"
{
    Caption = 'Journal Returns Line';
    ...
    fields
    {
        ...
        field(3; "Type of Return"; Option)
        {
            ...
            Editable = false;
            OptionCaption = 'Subcontracting,Purchase';
        ...
        field(8; Quantity; Decimal)
        {
            ...
            trigger OnValidate()
            begin
                Amount:=Quantity * "Unit Amount" end;
        }
        ...
        field(35; "Reclass. Location"; Code[10])
        {
            Caption = 'Reclass. Location';
            TableRelation = Location;
            DataClassification = CustomerContent;
        }
        field(36; "Reclassif. Bin No."; Code[20])
        {
            Caption = 'Reclassif. Bin No.';
            TableRelation = Bin.Code where("Location Code"=field("Reclass. Location"));
            DataClassification = CustomerContent;
        }
        field(37; "Reclassif. Code"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                if ItemsReclass.Get("Item No.", "Reclassif. Code")then "Reclassif. Factor":=ItemsReclass."Reclassif. Factor";
            end;
        }
        ...
        field(100; "Posted Entry No."; Integer)
        {
    ...
    trigger OnDelete()
    begin
        QualityReturnMan.ModifyItemLdgrEntryForReturn(Rec);
    end;
    var QualityReturnMan: Codeunit "Quality Return Management";
    Txt00001: label 'Good quantity can not be negative';
    ItemsReclass: Record "SSD Items Reclassification";
    procedure UpdateQuantity()
    begin
        "Good Qty.":=Quantity - "Qty. to Reclass." - "Qty. to Return";
        if "Good Qty." < 0 then Error(Txt00001);
    end;
}
