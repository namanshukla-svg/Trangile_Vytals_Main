Report 50249 "Customer Ledger-New"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Customer Ledger-New.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    if GLEntry.FindFirst then begin
                        GLName:='';
                        // Locationcode := GLEntry."Location Code";
                    ...
                    */
                    if I = 0 then begin
                        OpeningBalanceLCY:=StartBalanceLCY; //Ayan
                        I:=1;
                    end;
                    gDecCustBal:=OpeningBalanceLCY + Abs(CustDrAmt) - Abs(CustCrAmt); //Ayan ALLE-HB
                    OpeningBalanceLCY:=gDecCustBal;
                ...
                begin
                    ...
                    //CurrReport.CREATETOTALS(CustAmount,"Amount (LCY)","Credit Amount (LCY)","Debit Amount (LCY)",CustBalanceLCY);
            ...
            begin
                ...
                //gDecCustBal := StartBalanceLCY;  //Ayan //Alle.SP.01
                //Alle-HB-12oct15
                CLE.Reset;
                ...
                //Alle-HB-12oct15
                //Alle.SP.01
                if CustCrAmt > 0 then gIndCator:='Cr'
                else
                    gIndCator:='Dr';
            //Alle.SP.01
            end;
            ...
            begin
                ...
                CountInt:=0;
                OpeningBalanceLCY:=Customer."Net Change (LCY)";
            end;
        }
    }
    requestpage
