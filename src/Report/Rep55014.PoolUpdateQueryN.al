report 55014 "Pool Update Query N"
{
    ApplicationArea = All;
    Caption = 'Pool Update N';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/55014_PoolUpdateQueryN.rdl';
            ...
            begin
                ...
                while PoolUpdate1.Read() do begin
                    if not SSDPoolUpdateTable.Get(PoolUpdate1.Code, PoolUpdate1.Sales_Region) then begin
                        ...
                        // if (PoolUpdate1.Sales_Region = PoolUpdate1.Sales_Region::"Key") or (PoolUpdate1.Sales_Region = PoolUpdate1.Sales_Region::Channel) or (PoolUpdate1.Sales_Region = PoolUpdate1.Sales_Region::Export) or (PoolUpdate1.Sales_Region = PoolUpdate1.Sales_Region::"Others-Institutional") then
                        //     SSDPoolUpdateTable."Group No." := 'GP1'
                        // else
                ...
                while PoolUpdate2.Read() do begin
                    if not SSDPoolUpdateTable.Get(PoolUpdate2.Code, PoolUpdate2.Sales_Region) then begin
                        ...
                        // if (PoolUpdate2.Sales_Region = PoolUpdate2.Sales_Region::"Key") or (PoolUpdate2.Sales_Region = PoolUpdate2.Sales_Region::Channel) or (PoolUpdate2.Sales_Region = PoolUpdate2.Sales_Region::Export) or (PoolUpdate2.Sales_Region = PoolUpdate2.Sales_Region::"Others-Institutional") then
                        //     SSDPoolUpdateTable."Group No." := 'GP1'
                        // else
                        SSDPoolUpdateTable."Group No." := 'GP2';
                        SSDPoolUpdateTable.Insert();
                ...
                while PoolUpdate3.Read() do begin
                    if not SSDPoolUpdateTable.Get(PoolUpdate3.Code, PoolUpdate3.Sales_Region) then begin
                        ...
                        // if (PoolUpdate3.Sales_Region = PoolUpdate3.Sales_Region::"Key") or (PoolUpdate3.Sales_Region = PoolUpdate3.Sales_Region::Channel) or (PoolUpdate3.Sales_Region = PoolUpdate3.Sales_Region::Export) or (PoolUpdate3.Sales_Region = PoolUpdate3.Sales_Region::"Others-Institutional") then
                        //     SSDPoolUpdateTable."Group No." := 'GP1'
                        // else
                        SSDPoolUpdateTable."Group No." := 'GP2';
                        SSDPoolUpdateTable.Insert();
