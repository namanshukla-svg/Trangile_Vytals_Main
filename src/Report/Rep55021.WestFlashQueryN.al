report 55021 "West Flash Query N"
{
    ApplicationArea = All;
    Caption = 'West Flash N';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/55009_WestFlashQueryN.rdl';
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                PoolUpdate1.SetRange(PoolUpdate1.Sales_Region, PoolUpdate1.Sales_Region::West);
                PoolUpdate1.Open();
                ...
                PoolUpdate2.SetRange(PoolUpdate2.Sales_Region, PoolUpdate2.Sales_Region::West);
                PoolUpdate2.Open();
                ...
                PoolUpdate2A.SetRange(PoolUpdate2A.Sales_Region, PoolUpdate2A.Sales_Region::West);
                PoolUpdate2A.Open();
                ...
                PoolUpdate3.SetRange(PoolUpdate3.Sales_Region, PoolUpdate3.Sales_Region::West);
                PoolUpdate3.Open();
