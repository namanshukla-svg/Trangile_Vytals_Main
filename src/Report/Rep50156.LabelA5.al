Report 50156 "Label - A5"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Label - A5.rdl';
    ...
    dataset
    {
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            RequestFilterFields = "Entry No.", "Document No.", "Location Code", "Package No.", "Lot No.";

            column(LabelQRCode; MfgSetup."Label QR Code") { }//IG_DS 
            column(Package_No_; "Package No.") { } //IG_DS
            ...
            column(PackageLabel; 'Package No.')
            {
            }
            ...
            column(PackageQRCode; PackageQRCode)
            {
            }
            ...
            begin
                ...
                //IG_DS
                QRCodeInput := "Item Ledger Entry"."Package No.";
                TempBlob1.CreateInStream(IS_iIN);
