report 50484 "Key Flash Query"
{
    ApplicationArea = All;
    Caption = 'Key Flash';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/50484_KeyFlashQuery.rdl';
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                PoolUpdate1.SetRange(PoolUpdate1.Category, PoolUpdate1.Category::"Key");
                PoolUpdate1.Open();
                ...
                PoolUpdate2.SetRange(PoolUpdate2.Category, PoolUpdate2.Category::"Key");
                PoolUpdate2.Open();
                ...
                PoolUpdate3.SetRange(PoolUpdate3.Category, PoolUpdate3.Category::"Key");
                PoolUpdate3.Open();
