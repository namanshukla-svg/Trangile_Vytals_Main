report 55020 "East Flash Query N"
{
    ApplicationArea = All;
    Caption = 'East Flash N';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/55007_EastFlashQueryN.rdl';
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                PoolUpdate1.SetRange(PoolUpdate1.Sales_Region, PoolUpdate1.Sales_Region::East);
                PoolUpdate1.Open();
                ...
                PoolUpdate2.SetRange(PoolUpdate2.Sales_Region, PoolUpdate2.Sales_Region::East);
                PoolUpdate2.Open();
                ...
                PoolUpdate2A.SetRange(PoolUpdate2A.Sales_Region, PoolUpdate2A.Sales_Region::East);
                PoolUpdate2A.Open();
                ...
                PoolUpdate3.SetRange(PoolUpdate3.Sales_Region, PoolUpdate3.Sales_Region::East);
                PoolUpdate3.Open();
