report 55019 "North Flash Query N"
{
    ApplicationArea = All;
    Caption = 'North Flash N';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/55006_NorthFlashQueryN.rdl';
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                PoolUpdate1.SetRange(PoolUpdate1.Sales_Region, PoolUpdate1.Sales_Region::North);
                PoolUpdate1.Open();
                ...
                PoolUpdate2.SetRange(PoolUpdate2.Sales_Region, PoolUpdate2.Sales_Region::North);
                PoolUpdate2.Open();
                ...
                PoolUpdate2A.SetRange(PoolUpdate2A.Sales_Region, PoolUpdate2A.Sales_Region::North);
                PoolUpdate2A.Open();
                ...
                PoolUpdate3.SetRange(PoolUpdate3.Sales_Region, PoolUpdate3.Sales_Region::North);
                PoolUpdate3.Open();
