Report 50117 "Certificate of Analysis.PSI"
{
    // 
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Certificate of Analysis.PSI.rdl';
                ...
                dataitem("Posted Quality Order Header"; "SSD Posted Quality Order Hdr")
                {
                    ...
                    dataitem("Posted Quality Order Line"; "SSD Posted Quality Order Line")
                    {
                        ...
                        begin
                            ...
                            //Alle 200820
                            if QualityMeasurements."Unit of Measure Code" <> '' then UnitofMeasureDesc:=UnitofMeasure.Description
                            else
                    ...
                    begin
                        ...
                        if COMPANYNAME = 'Zavenir Kluthe India (P) Ltd.' then IsQualityCheck:='YES'
                        else
                        begin
                            Item.Reset;
