Report 50491 "Service Order Report"
{
    Caption = 'Service Order';
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ServiceOrderReport.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(SSDOrderType_PurchaseHeader; "SSD Order Type")
            {
            }
            ...
            column(ItemVendDescVisible; ItemVendDescVisible)
            {
            }
            column(RevisionNo; RevisionNo)
            {
            }
            column(RevisionDate; Format(RevisionDate))
            {
            }
            column(Status; Status)
            {
            }
            column(VendorOfferRefNoAndDate; UpperCase(VendorOfferRefNoAndDate))
            {
            }
            column(DeliveryTerms; DeliveryTerms)
            {
            }
            column(BuyerDeatils; UpperCase(CompInfo.Name + ' ' + CompInfo."Name 2" + ', ' + CompInfo."Phone No." + ', ' + CompInfo."E-Mail"))
            {
            }
            column(Validity; UpperCase(Validity))
            {
            }
            ...
            column(BillToGSTINLbl; BillToGSTINLbl)
            {
            }
            column(PANNo; PANNo)
            {
            }
            column(ShipToGSTINLbl; ShipToGSTINLbl)
            {
            }
            ...
            column(LetterHeadHeader; CompInfo."Letter Head Header")
            {
            }
            column(LetterHeadFooter; CompInfo."Letter Head Footer")
            {
            }
            ...
            column(UPPERCASE__Purchase_Header___Buy_from_Vendor_No_____________Purchase_Header___Buy_from_Vendor_Name__; UpperCase("Purchase Header"."Buy-from Vendor No."))
            {
            }
            column(UPPERCASE__Purchase_Header___Buy_from_Vendor_No_____________Purchase_Header___Buy_from_Vendor_Name__2; UpperCase("Purchase Header"."Buy-from Vendor Name"))
            {
            }
            column(Purchase_Header__No__; "No.")
            {
            }
            column(ORDER_NO__; OrderNoCaption)
            {
            }
            column(DATE_;'DATE')
            {
            ...
            column(UPPERCASE__Purchase_Header___Buy_from_City_____________Purchase_Header___Buy_from_Post_Code__; UpperCase("Purchase Header"."Buy-from City" + ' - ' + "Purchase Header"."Buy-from Post Code" + ',' + UpperCase(StateRec.Description)))
            {
            }
            column(UPPERCASE_StateRec_Description_; UpperCase("Purchase Header"."Pay-to Country/Region Code"))
            {
            }
            ...
            column(EmailForPOSending; UpperCase(Vendor."Email For PO Sending"))
            {
            }
            column(Vendor_CONTACT; UpperCase(Vendor.Contact))
            {
            }
            column(Vendor_Phone; UpperCase(Vendor."Phone No."))
            {
            }
            ...
            column(Purchaser_Name; UpperCase(Purchaser.Name))
            {
            }
            column(Purchaser__E_Mail_; UpperCase(Purchaser."E-Mail"))
            {
            }
            column(Purchaser__PhoneNo_; UpperCase(Purchaser."Phone No."))
            {
            }
            ...
            column(ITEM_DESCRIPTION_; ITEMDESCRIPTIONCapt)
            {
            }
            column(UOM_;'UOM')
            {
            ...
            column(ITEM_DESCRIPTION__Control1000000165; ITEMDESCRIPTIONCapt)
            {
            }
            column(SPO_Subject; "SSD SPO Subject")
            {
            }
            dataitem("Document Attachment"; "Document Attachment")
            {
                DataItemTableView = where("Table ID"=const(Database::"Purchase Header"), "Document Type"=const(Order));
                DataItemLink = "No."=field("No.");
                DataItemLinkReference = "Purchase Header";

                column(SSDIsAnnexure_DocumentAttachment; "SSD Is Annexure")
                {
                }
                column(SSDDescription_DocumentAttachment; "SSD Description")
                {
                }
                column(FileName_DocumentAttachment; "File Name")
                {
                }
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(Description_______Description_2_; VendItemDesc)
                {
                }
                column(EmptyString;'')
                {
                ...
                begin
                    ...
                    // //ALLE Code.Begin[US]
                    // //ALLE Code.End[US]
                    VendItemDesc:=Description + '  ' + "Description 2" + ' ' + "Description 3";
                end;
            ...
            dataitem(Structure; "Purchase Line")
            {
                ...
                column(ROUND_Structure__Tax____0_1_;0)
                {
                }
                ...
                column(Structure_Structure__Amount_Including_Tax__Control1000000041; Structure.Amount)
                {
                }
                ...
                begin
                    ...
                    TaxTransactionValue.SetRange("Value Type", TaxTransactionValue."Value Type"::COMPONENT);
                    IF TaxTransactionValue.FindSet()then repeat if TaxTransactionValue."Value ID" = 1 then begin
            ...
            dataitem("SSD PO Terms"; "SSD PO Terms")
            {
                DataItemLink = "Document No."=field("No.");
                ...
                column(Sub_Sequence_No_; "Sub Sequence No.")
                {
                }
                column(IsHeader_SSDPOTerms; "Is Header")
                {
                }
                column(PrintonPO_SSDPOTerms; "Print on PO")
                {
                }
                column(SSDAttachmentType_SSDPOTerms; "SSD Attachment Type")
                {
                }
                column(AttachmentRequired_SSDPOTerms; "Attachment Required")
                {
                }
                column(CheckList_SSDPOTerms; PrintAttachmentDetails)
                {
                }
                column(Description_SSDPOTerms; TermsandConditions)
                {
                }
                column(DocumentNo_SSDPOTerms; "Document No.")
                {
                }
                column(DocumentType_SSDPOTerms; "Document Type")
                {
                }
                column(LineNo_SSDPOTerms; "Line No.")
                {
                }
                column(TCCode_SSDPOTerms; "TC Code")
                {
                }
                column(Num2; Num2)
                {
                ...
                begin
                    Num2+=1;
                    IF "Sub Sequence No." <> '' then TermsandConditions:="Sub Sequence No." + '. ' + Description
                    ELSE
                        TermsandConditions:=Description;
                    if("SSD PO Terms"."Print on PO" = true) and (format("SSD PO Terms"."SSD Attachment Type") <> '')then PrintAttachmentDetails:=true
                    else
                        PrintAttachmentDetails:=false;
                end;
            }
            trigger OnAfterGetRecord()
            var
            ...
            begin
                if Status <> Status::Released then OrderNoCaption:='SERVICE ORDER NO.'
                else
                    OrderNoCaption:='SERVICE ORDER NO.';
                RevisionDate:=0D;
                CalcFields("No. of Archived Versions");
                RevisionNo:="No. of Archived Versions";
                if RevisionNo <> 0 then begin
                    PurchaseHeaderArchiveRec.Reset();
                    PurchaseHeaderArchiveRec.SetRange("Document Type", "Document Type");
                    PurchaseHeaderArchiveRec.SetRange("No.", "No.");
                    PurchaseHeaderArchiveRec.SetRange("Doc. No. Occurrence", "Doc. No. Occurrence");
                    PurchaseHeaderArchiveRec.SetRange("Version No.", "No. of Archived Versions");
                    if PurchaseHeaderArchiveRec.FindFirst()then RevisionDate:=PurchaseHeaderArchiveRec."Date Archived";
                end;
                SrNo1:=0;
                countt:=0;
                Vendor.Get("Purchase Header"."Buy-from Vendor No.");
                PurchLine4.reset;
                PurchLine4.SetRange("Document No.", "Purchase Header"."No.");
                PurchLine4.SetFilter("Vendor Item Description", '<>%1', '');
                if PurchLine4.FindFirst()then ItemVendDescVisible:=true;
                ...
                if PurchCommentLine.FindSet then repeat RemarksTxt+=PurchCommentLine.Comment + '\';
                ...
                if Location.Get("Purchase Header"."Location Code")then begin
                    if Location."Temp JW Location" then begin
                        ...
                        if Location."Temp State Code" <> '' then States.Get(Location."Temp State Code")
                        else
                ...
                if GeneralLedgerSetup."SSD Activate Item Vendor" then begin
                    ...
                    PurchaseLineRec.SetFilter("Vendor Item Description", '<>%1', '');
                    if PurchaseLineRec.FindFirst()then begin
                        ITEMDESCRIPTIONCapt:='ITEM DESCRIPTION (VENDOR ITEM DESCRIPTION)';
                    end;
                end
                else
                    ITEMDESCRIPTIONCapt:='ITEM DESCRIPTION';
                VendorOfferRefNoAndDate:='';
                Validity:='';
                VendorOfferRefNoAndDate:="Your Reference";
                IF "Valid From" <> 0D then Validity:=Format("Valid From") + ' TO ' + Format("Valid To");
            // ContactPhoneNo := '';
            // ContactEMail := '';
            // ContactName := '';
    ...
    begin
        ...
        CompInfo.CalcFields("Letter Head Footer");
        CompInfo.CalcFields("Letter Head Header");
        IVD:=0;
        Num2:=0;
    end;
    var ContactPhoneNo: Text;
    ContactEMail: text;
    ContactName: text;
    ...
    DeliveryTerms: Text;
    BuyerDeatils: Text;
    VendorOfferRefNoAndDate: Text;
    SSDPOTermsRec: Record "SSD PO Terms";
    ...
    BillToGSTINLbl: label 'Bill To GSTIN';
    PANNo: Text;
    ShipToGSTINLbl: label 'Ship To GSTIN';
    ...
    ReportFooter2: label 'Fax +91 11 66544052 | Email ccare@zavenir.com | www.zavenir.com | ';
    SpeInstructionText1: label 'ZAVENIR RESERVES THE RIGHT TO CANCEL EITHER ENTIRE OR PART OF THE ORDER WITHOUT ASSIGNING ANY REASONS. ANY REJECTIONS WILL BE TO YOUR ACCOUNT INCLUDING ALL COSTS.';
    SpeInstructionText2: label 'PLEASE SEND THE MATERIAL ALONG WITH TEST CERTIFICATE.';
    HeaderReport1: label '57Th KM STONE, DELHI - JAIPUR HIGHWAY, VILLAGE BINOLA, DISTRICT GURGAON - 122 413,HARYANA, INDIA';
    ...
    TDSAmt: Decimal;
    TDSPer: Decimal;
    ItemVendDescVisible: boolean;
    PrintAttachmentDetails: Boolean;
    VendItemDesc: Text;
