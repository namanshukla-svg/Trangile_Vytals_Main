Report 50026 "Gate Pass RGP Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Gate Pass RGP Receipt.rdl';
    UsageCategory = Lists;
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("RGP Receipt Header"; "SSD RGP Receipt Header")
        {
            ...
            dataitem("RGP Receipt Line"; "SSD RGP Receipt Line")
            {
                ...
                column(itemdesc; RGPLine.Description + '  ' + RGPLine."Description 2")
                {
                }
                ...
                begin
                    ...
                    RGPLine.SetRange("Document No.", "Pre-Assigned No.");
                    RGPLine.SetRange("Line No.", "Line No.");
            ...
            begin
                ...
                if "RGP Receipt Header".NRGP = true then Heading:='NON-RETURNABLE  GATE  PASS   (NRGP-IN)'
                else
                    Heading:='RETURNABLE  GATE  PASS   (RGP-IN)';
                // IF NOT "RGP Receipt Header".NRGP THEN
                //  Heading := 'RETURNABLE  GATE  PASS   (RGP-IN)'
                // ELSE
                //  Heading := 'NON-RETURNABLE  GATE  PASS   (NRGP-IN)';
    ...
    begin
        ...
        //Alle AU 18042020
        if CompInfo.Name = 'Zavenir Daubert India Private Limited' then Namec:='Zavenir Daubert India Private Limited'
        else
            Namec:='Zavenir Kluthe India Private Limited';
    end;
