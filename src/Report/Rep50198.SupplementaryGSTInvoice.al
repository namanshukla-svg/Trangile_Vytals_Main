Report 50198 "Supplementary GST Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Supplementary GST Invoice.rdl';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                dataitem("Sales Invoice Line"; "Sales Invoice Line")
                {
                    ...
                    // {
                    // }
                    // column(GrandAmount;"Amount To Customer")
                    // {
                    // }
                    ...
                    begin
                        ...
                        //   RecCrossReference.SetRange("Cross-Reference Type",RecCrossReference."cross-reference type"::Customer);
                        //   RecCrossReference.SetRange(RecCrossReference."Cross-Reference Type No.","Sell-to Customer No.");
                        //   if not RecCrossReference.FindFirst then
                        //     RecCrossReference."Cross-Reference No." := '';
                        // end;
                        // //<<Alle VPB
                        // if "Sales Invoice Header"."Transaction No. Serv. Tax" <> 0 then begin
                        //   ServiceTaxEntry.Reset;
