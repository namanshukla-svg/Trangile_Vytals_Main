report 50018 "GSTR_2 File Format New"
{
    Caption = 'GSTR-2 File Format New';
    ProcessingOnly = true;
    UseRequestPage = true;
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                case TypeOfSupply of TypeOfSupply::B2B: begin
                    MakeExcelBodyB2B();
                    createbookandopenExcel(B2BTxt);
                end;
                TypeOfSupply::IMPS: begin
                    MakeExcelBodyIMPS();
                    createbookandopenExcel(IMPSTxt);
                end;
                TypeOfSupply::IMPG: begin
                    MakeExcelBodyIMPG();
                    createbookandopenExcel(IMPGTxt);
                end;
                TypeOfSupply::B2BUR: begin
                    MakeExcelBodyB2BUR();
                    createbookandopenExcel(B2BURTxt);
                end;
                TypeOfSupply::CDNR: begin
                    MakeExcelBodyCDNR();
                    createbookandopenExcel(CDNRTxt);
                end;
                TypeOfSupply::CDNUR: begin
                    MakeExcelBodyCDNUR();
                    createbookandopenExcel(CDNURTxt);
                end;
                TypeOfSupply::AT: begin
                    MakeExcelBodyAT();
                    createbookandopenExcel(ATTxt);
                end;
                TypeOfSupply::EXEMP: begin
                    MakeExcelHeaderEXEMP();
                    CreateExcelBufferExemp();
                    createbookandopenExcel(EXEMPTxt);
                end;
                TypeOfSupply::ATADJ: begin
                    Error('This feature will be available in the next release.');
                // MakeExcelBodyATADJ();
                // createbookandopenExcel(ATADJTxt);
                end;
                TypeOfSupply::ITCR: begin
                    Error('This feature will be available in the next release.');
                // MakeExcelBodyATADJ();
                // createbookandopenExcel(ATADJTxt);
                end;
                TypeOfSupply::HSNSUM: begin
                    MakeExcelBodyHSNSUM();
    ...
    TypeOfSupply: Option " ", B2B, B2BUR, IMPS, IMPG, CDNR, CDNUR, AT, ATADJ, EXEMP, ITCR, HSNSUM;
    GSTBaseAmtIntra: Decimal;
    GSTBaseAmtInter: Decimal;
    NatureOfSupplyOption: Option " ", B2B, B2BUR, IMPS, IMPG, CDNR, CDNUR, AT, ATADJ, EXEMP, ITCR, HSNSUM;
    DocumentNumber: Text;
    //GstRate: Integer;
    B2BTxt: Label 'B2B';
    IMPSTxt: Label 'IMPS';
    ...
    IntegratedTaxAmtTxt: Label 'IGST Amount';
    CentralTaxPaidTxt: Label 'Central Tax Paid';
    CentralTaxAmtTxt: Label 'CGST Amount';
    StateTaxPaidTxt: Label 'State/UT Tax Paid';
    StateTaxAmtTxt: Label 'SGST Amount';
    ...
    begin
        ...
        GSTR2B2BQuery.Open();
        while GSTR2B2BQuery.Read()do if(GSTR2B2BQuery.GST_Vendor_Type = GSTR2B2BQuery.GST_Vendor_Type::Registered)then begin
                if(GSTR2B2BQuery.Reverse_Charge = true) and (GSTR2B2BQuery.Entry_Type = GSTR2B2BQuery.Entry_Type::Application)then CreateExcelBufferB2B(GSTR2B2BQuery)
                else if(GSTR2B2BQuery.Reverse_Charge = false) and (GSTR2B2BQuery.Entry_Type = GSTR2B2BQuery.Entry_Type::"Initial Entry")then CreateExcelBufferB2B(GSTR2B2BQuery);
            end
            else if(GSTR2B2BQuery.GST_Vendor_Type = GSTR2B2BQuery.GST_Vendor_Type::SEZ) and (GSTR2B2BQuery.GST_Group_Type = GSTR2B2BQuery.GST_Group_Type::Goods) and (GSTR2B2BQuery.Without_Bill_Of_Entry = true)then begin
                    if(GSTR2B2BQuery.Reverse_Charge = true) and (GSTR2B2BQuery.Entry_Type = GSTR2B2BQuery.Entry_Type::Application)then CreateExcelBufferB2B(GSTR2B2BQuery)
                    else if(GSTR2B2BQuery.Reverse_Charge = false) and (GSTR2B2BQuery.Entry_Type = GSTR2B2BQuery.Entry_Type::"Initial Entry")then CreateExcelBufferB2B(GSTR2B2BQuery);
                end
                else if(GSTR2B2BQuery.GST_Vendor_Type = GSTR2B2BQuery.GST_Vendor_Type::SEZ) and (GSTR2B2BQuery.GST_Group_Type = GSTR2B2BQuery.GST_Group_Type::Service)then if(GSTR2B2BQuery.Reverse_Charge = true) and (GSTR2B2BQuery.Entry_Type = GSTR2B2BQuery.Entry_Type::Application)then CreateExcelBufferB2B(GSTR2B2BQuery)
                        else if(GSTR2B2BQuery.Reverse_Charge = false) and (GSTR2B2BQuery.Entry_Type = GSTR2B2BQuery.Entry_Type::"Initial Entry")then CreateExcelBufferB2B(GSTR2B2BQuery);
    end;
    ...
    begin
        ...
        if pDate = 0D then pDate:=GSTR2B2BQuery.Posting_Date;
        ...
        if State.Get(GSTR2B2BQuery.Buyer_Seller_State_Code)then TempExcelBuffer.AddColumn(State."State Code (GST Reg. No.)" + '-' + State.Description, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        if GSTR2B2BQuery.Reverse_Charge then TempExcelBuffer.AddColumn(YTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text)
        else
        ...
        GSTR2GSTPer.Open();
        while GSTR2GSTPer.Read()do if GSTR2GSTPer.GST_Jurisdiction_Type = GSTR2GSTPer.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(2 * GSTR2B2BQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        GSTR2BaseAmt.Open();
        while GSTR2BaseAmt.Read()do if GSTR2BaseAmt.GST_Jurisdiction_Type = GSTR2BaseAmt.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(Abs(GSTR2B2BQuery.GST_Base_Amount / 2), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        GSTR2IGST.Open();
        if GSTR2IGST.Read()then TempExcelBuffer.AddColumn(Abs(GSTR2IGST.GST_Amount), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
        ...
        GSTR2CGSTAmt.Open();
        if GSTR2CGSTAmt.Read()then TempExcelBuffer.AddColumn(Abs(GSTR2CGSTAmt.GST_Amount), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
        ...
        GSTR2SGSTAmt.Open();
        if GSTR2SGSTAmt.Read()then TempExcelBuffer.AddColumn(Abs(GSTR2SGSTAmt.GST_Amount), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        CessAmt:=GetCessAmt(GSTR2B2BQuery.Document_No_, GSTR2B2BQuery.GST__);
        if(CessAmt <> 0)then TempExcelBuffer.AddColumn(Abs(CessAmount), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        ...
        if(CessAmountCrAvailed <> 0)then TempExcelBuffer.AddColumn(Abs(CessAmountCrAvailed), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        ...
        DetailedGSTLedgerEntry.SetRange("Document No.", GSTR2B2BQuery.Document_No_);
        if DetailedGSTLedgerEntry.FindFirst()then begin
            vendorNo:=DetailedGSTLedgerEntry."Source No.";
            if VendorRec.Get(vendorNo)then VendorName:=VendorRec.Name;
        end;
    ...
    local procedure GetInvoiceType(GSTR2B2BQuery: Query GSTR2B2BQuery): Text[50]begin
        case GSTR2B2BQuery.GST_Vendor_Type of GSTR2B2BQuery.GST_Vendor_Type::Registered: exit(RegularTxt);
        GSTR2B2BQuery.GST_Vendor_Type::SEZ: begin
            if GSTR2B2BQuery.GST_Without_Payment_of_Duty then exit(SEZWOPayTxt);
            exit(SEZWPayTxt);
        end;
        end;
    end;
    local procedure GetInvoiceValue(DocumentNo: Code[20]; DocumentType: Enum "GST Document Type"): Decimal var
        VendorLedgerEntry: Record "Vendor Ledger Entry";
    begin
        VendorLedgerEntry.SetRange("Document Type", DocumentType);
        VendorLedgerEntry.SetRange("Document No.", DocumentNo);
        if VendorLedgerEntry.FindFirst()then VendorLedgerEntry.CalcFields("Amount (LCY)");
    ...
    begin
        ...
        GSTR2IMPSQuery.Open();
        while GSTR2IMPSQuery.Read()do if(GSTR2IMPSQuery.Reverse_Charge = true) and (GSTR2IMPSQuery.Entry_Type = GSTR2IMPSQuery.Entry_Type::Application)then CreateExcelBufferIMPS(GSTR2IMPSQuery)
            else if(GSTR2IMPSQuery.Reverse_Charge = false) and (GSTR2IMPSQuery.Entry_Type = GSTR2IMPSQuery.Entry_Type::"Initial Entry")then CreateExcelBufferIMPS(GSTR2IMPSQuery);
    end;
    ...
    begin
        ...
        if pDate = 0D then pDate:=GSTR2IMPSQuery.Posting_Date;
        TempExcelBuffer.AddColumn(pDate, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Date);
        ...
        if(GSTR2IMPSQuery.GST_Vendor_Type = GSTR2IMPSQuery.GST_Vendor_Type::SEZ)then if State.Get(GSTR2IMPSQuery.Buyer_Seller_State_Code)then TempExcelBuffer.AddColumn(State."State Code (GST Reg. No.)" + '-' + State.Description, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text)
            else
                TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text)
        else
            State.Get(GSTR2IMPSQuery.Location_State_Code);
        if((GSTR2IMPSQuery.GST_Vendor_Type = GSTR2IMPSQuery.GST_Vendor_Type::Import))then TempExcelBuffer.AddColumn(State."State Code (GST Reg. No.)" + '-' + State.Description, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        ...
        GSTR2GSTPer.Open();
        if GSTR2GSTPer.Read()then if GSTR2GSTPer.GST_Jurisdiction_Type = GSTR2GSTPer.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(2 * GSTR2IMPSQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        GSTR2BaseAmt.Open();
        if GSTR2BaseAmt.Read()then if GSTR2BaseAmt.GST_Jurisdiction_Type = GSTR2BaseAmt.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(Abs(GSTR2IMPSQuery.GST_Base_Amount / 2), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        if GSTR2IMPSIGSTAmt.Read()then TempExcelBuffer.AddColumn(GSTR2IMPSIGSTAmt.GST_Amount, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        ...
        GSTR2CessAmt.Open();
        if GSTR2CessAmt.Read()then TempExcelBuffer.AddColumn(GSTR2CessAmt.GST_Amount, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        ...
        GSTR2IMPSIGSTAmt.Open();
        if GSTR2IMPSIGSTAmt.Read()then TempExcelBuffer.AddColumn(Abs(GSTR2IMPSIGSTAmt.GST_Amount), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        GSTR2CessAmt.SetRange(Location__Reg__No_, LocationGSTIN);
        GSTR2CessAmt.SetRange(Posting_Date, StartDate, EndDate);
        ...
        GSTR2CessAmt.Open();
        if GSTR2CessAmt.Read()then TempExcelBuffer.AddColumn(Abs(GSTR2CessAmt.GST_Amount), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
    end;
    ...
    begin
        ...
        if DtldGSTLedgeEntry.FindFirst()then if(DtldGSTLedgeEntry."Entry Type" = DtldGSTLedgeEntry."Entry Type"::"Initial Entry")then PostingDate:=DtldGSTLedgeEntry."Posting Date"
            else
    ...
    begin
        ...
        GSTR2IMPGQuery.Open();
        while GSTR2IMPGQuery.Read()do if(GSTR2IMPGQuery.GST_Vendor_Type = GSTR2IMPGQuery.GST_Vendor_Type::Import)then CreateExcelBufferIMPG(GSTR2IMPGQuery)
            else if(GSTR2IMPGQuery.GST_Vendor_Type = GSTR2IMPGQuery.GST_Vendor_Type::SEZ) and (GSTR2IMPGQuery.Without_Bill_Of_Entry = false)then CreateExcelBufferIMPG(GSTR2IMPGQuery);
    end;
    local procedure GetCessAmt(DocumentNo: code[20]; GstRate: Decimal): Decimal var
        DetailedGSTLedgerEntry: Record "Detailed GST Ledger Entry";
    ...
    begin
        ...
        if DetailedGSTLedgerEntry.FindSet()then repeat if DocLineNo <> DetailedGSTLedgerEntry."Document Line No." then begin
                    ...
                    if DetailedGSTLedgerEntryCess.FindSet()then repeat CessAmt+=DetailedGSTLedgerEntryCess."GST Amount";
                        until DetailedGSTLedgerEntryCess.Next() = 0;
                end;
            until DetailedGSTLedgerEntry.Next() = 0;
        exit(CessAmt);
    end;
    local procedure GetCessAmtCreditAvailed(DocumentNo: code[20]; GstRate: Decimal): Decimal var
        DetailedGSTLedgerEntry: Record "Detailed GST Ledger Entry";
        DetailedGSTLedgerEntryCess: Record "Detailed GST Ledger Entry";
        CessAmt: Decimal;
        DocLineNo: Integer;
    ...
    begin
        ...
        while GSTR2GSTPer.Read()do begin
            if GSTR2GSTPer.GST_Jurisdiction_Type = GSTR2GSTPer.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(2 * GSTR2IMPGQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        while GSTR2IMPGBaseAmt.Read()do if GSTR2IMPGBaseAmt.GST_Jurisdiction_Type = GSTR2IMPGBaseAmt.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(Abs(GSTR2IMPGQuery.GST_Base_Amount / 2), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        if(CessAmt <> 0)then TempExcelBuffer.AddColumn(CessAmt, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        ...
        if(CessAmountCrAvailed <> 0)then TempExcelBuffer.AddColumn(CessAmountCrAvailed, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
    end;
    local procedure GetBillOfEntryValue(DocumentNo: Code[20]): Decimal var
        PurchInvHeader: Record "Purch. Inv. Header";
    begin
        PurchInvHeader.SetRange("No.", DocumentNo);
        if PurchInvHeader.FindFirst()then PurchInvHeader.CalcSums("Bill of Entry Value");
    ...
    begin
        ...
        while GSTR2B2BURQuery.Read()do if(GSTR2B2BURQuery.Reverse_Charge = true) and (GSTR2B2BURQuery.Entry_Type = GSTR2B2BURQuery.Entry_Type::Application)then CreateExcelBufferB2BUR(GSTR2B2BURQuery)
            else if(GSTR2B2BURQuery.Reverse_Charge = false) and (GSTR2B2BURQuery.Entry_Type = GSTR2B2BURQuery.Entry_Type::"Initial Entry")then CreateExcelBufferB2BUR(GSTR2B2BURQuery);
    end;
    ...
    begin
        TempExcelBuffer.NewRow();
        if GSTR2B2BURQuery.Source_No_ <> '' then TempExcelBuffer.AddColumn(GSTR2B2BURQuery.Name, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        ...
        if pDate = 0D then pDate:=GSTR2B2BURQuery.Posting_Date;
        TempExcelBuffer.AddColumn(pDate, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Date);
        ...
        if GSTR2B2BURQuery.Buyer_Seller_State_Code <> '' then TempExcelBuffer.AddColumn(GSTR2B2BURQuery.State_Code__GST_Reg__No__ + '-' + GSTR2B2BURQuery.Description, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        ...
        GSTR2GSTPer.Open();
        while GSTR2GSTPer.Read()do if GSTR2GSTPer.GST_Jurisdiction_Type = GSTR2GSTPer.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(2 * GSTR2B2BURQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        GSTR2BaseAmt.Open();
        while GSTR2BaseAmt.Read()do if GSTR2BaseAmt.GST_Jurisdiction_Type = GSTR2BaseAmt.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(Abs(GSTR2B2BURQuery.GST_Base_Amount / 2), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        GSTR2IGSTAmt.Open();
        if GSTR2IGSTAmt.Read()then TempExcelBuffer.AddColumn(Abs(GSTR2IGSTAmt.GST_Amount), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        GSTR2CGSTAmt.SetRange(Location__Reg__No_, LocationGSTIN);
        GSTR2CGSTAmt.SetRange(Posting_Date, StartDate, EndDate);
    ...
    begin
        ...
        GSTR2CDNRQuery.Open();
        while GSTR2CDNRQuery.Read()do if(GSTR2CDNRQuery.Document_Type = GSTR2CDNRQuery.Document_Type::"Credit Memo") or (GSTR2CDNRQuery.Document_Type = GSTR2CDNRQuery.Document_Type::Refund) or (GSTR2CDNRQuery.Document_Type = GSTR2CDNRQuery.Document_Type::Invoice) and (GSTR2CDNRQuery.Purchase_Invoice_Type = GSTR2CDNRQuery.Purchase_Invoice_Type::"Debit Note") or (GSTR2CDNRQuery.Purchase_Invoice_Type = GSTR2CDNRQuery.Purchase_Invoice_Type::Supplementary)then if(GSTR2CDNRQuery.Reverse_Charge = true) and (GSTR2CDNRQuery.Entry_Type = GSTR2CDNRQuery.Entry_Type::Application)then CreateExcelBufferCDNR(GSTR2CDNRQuery)
                else if(GSTR2CDNRQuery.Reverse_Charge = false) and (GSTR2CDNRQuery.Entry_Type = GSTR2CDNRQuery.Entry_Type::"Initial Entry")then CreateExcelBufferCDNR(GSTR2CDNRQuery);
    end;
    ...
    begin
        ...
        TempExcelBuffer.AddColumn(NTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        case GSTR2CDNRQuery.Document_Type of GSTR2CDNRQuery.Document_Type::"Credit Memo": TempExcelBuffer.AddColumn(CTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        GSTR2CDNRQuery.Document_Type::Refund: TempExcelBuffer.AddColumn(RTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        GSTR2CDNRQuery.Document_Type::Invoice: TempExcelBuffer.AddColumn(DTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        end;
        ...
        if GSTR2CDNRQuery.Document_Type in[GSTR2CDNRQuery.Document_Type::Invoice, GSTR2CDNRQuery.Document_Type::"Credit Memo"]then if GSTR2CDNRQuery.Finance_Charge_Memo then TempExcelBuffer.AddColumn(GetInvoiceValueFinCharge(GSTR2CDNRQuery.Document_No_), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
            else
        ...
        GSTR2GSTPer.Open();
        if GSTR2GSTPer.Read()then if GSTR2GSTPer.GST_Jurisdiction_Type = GSTR2GSTPer.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(2 * GSTR2CDNRQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number)
            else
                TempExcelBuffer.AddColumn(GSTR2CDNRQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        if GSTR2CDNRQuery.GST_Jurisdiction_Type = GSTR2CDNRQuery.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(Abs(GSTR2CDNRQuery.GST_Base_Amount / 2), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
        ...
        if(CessAmt <> 0)then TempExcelBuffer.AddColumn(Abs(CessAmt), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
    ...
    local procedure GetPostingDate(var ReferenceInvoiceNo: Record "Reference Invoice No."): Date var
    ...
    begin
        ...
        if VendLedgerEntry.FindFirst()then PostingDate:=VendLedgerEntry."Posting Date";
        exit(PostingDate);
    end;
    local procedure GSTDocumentType2DocumentTypeEnum(GSTDocumentType: Enum "GST Document Type"): Enum "Document Type Enum" begin
        case GSTDocumentType of GSTDocumentType::"Credit Memo": exit("Document Type Enum"::"Credit Memo");
        GSTDocumentType::Invoice: exit("Document Type Enum"::Invoice);
        GSTDocumentType::Refund: exit("Document Type Enum"::Refund);
        GSTDocumentType::Payment: exit("Document Type Enum"::Payment);
        end;
    end;
    local procedure GetInvoiceValueFinCharge(DocumentNo: Code[20]): Decimal var
        VendLedgerEntry: Record "Vendor Ledger Entry";
    begin
        ...
        if VendLedgerEntry.FindFirst()then VendLedgerEntry.CalcFields("Amount (LCY)");
    ...
    begin
        ...
        while GSTR2CDNURQuery.Read()do if(GSTR2CDNURQuery.Document_Type = GSTR2CDNURQuery.Document_Type::"Credit Memo") or (GSTR2CDNURQuery.Document_Type = GSTR2CDNURQuery.Document_Type::Refund) or (GSTR2CDNURQuery.Document_Type = GSTR2CDNURQuery.Document_Type::Invoice) and (GSTR2CDNURQuery.Purchase_Invoice_Type = GSTR2CDNURQuery.Purchase_Invoice_Type::"Debit Note") or (GSTR2CDNURQuery.Purchase_Invoice_Type = GSTR2CDNURQuery.Purchase_Invoice_Type::Supplementary)then if(GSTR2CDNURQuery.Reverse_Charge = true) and (GSTR2CDNURQuery.Entry_Type = GSTR2CDNURQuery.Entry_Type::Application)then CreateExcelBufferCDNUR(GSTR2CDNURQuery)
                else if(GSTR2CDNURQuery.Reverse_Charge = false) and (GSTR2CDNURQuery.Entry_Type = GSTR2CDNURQuery.Entry_Type::"Initial Entry")then CreateExcelBufferCDNUR(GSTR2CDNURQuery)
                    else if(GSTR2CDNURQuery.Reverse_Charge = true) and (GSTR2CDNURQuery.Entry_Type = GSTR2CDNURQuery.Entry_Type::"Initial Entry")then CreateExcelBufferCDNUR(GSTR2CDNURQuery);
    end;
    ...
    begin
        ...
        TempExcelBuffer.AddColumn(NTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        case GSTR2CDNURQuery.Document_Type of GSTR2CDNURQuery.Document_Type::"Credit Memo": TempExcelBuffer.AddColumn(CTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        GSTR2CDNURQuery.Document_Type::Refund: TempExcelBuffer.AddColumn(RTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        GSTR2CDNURQuery.Document_Type::Invoice: TempExcelBuffer.AddColumn(DTxt, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
        end;
        ...
        if(GSTR2CDNURQuery.Document_Type = GSTR2CDNURQuery.Document_Type::"Credit Memo") or (GSTR2CDNURQuery.Document_Type = GSTR2CDNURQuery.Document_Type::Refund)then TempExcelBuffer.AddColumn(GetInvoiceValue(GSTR2CDNURQuery.Document_No_, GSTR2CDNURQuery.Document_Type) + (GetGSTAmount(DetailedGSTLedgerEntry)), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
        ...
        GSTR2GSTPer.Open();
        while GSTR2GSTPer.Read()do if GSTR2GSTPer.GST_Jurisdiction_Type = GSTR2GSTPer.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(2 * GSTR2CDNURQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number)
            else
                TempExcelBuffer.AddColumn(GSTR2CDNURQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        if GSTR2CDNURQuery.GST_Jurisdiction_Type = GSTR2CDNURQuery.GST_Jurisdiction_Type::Intrastate then TempExcelBuffer.AddColumn(Abs(GSTR2CDNURQuery.GST_Base_Amount / 2), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
    ...
    local procedure GetGSTAmount(DetailedGSTLedgerEntry: Record "Detailed GST Ledger Entry"): Decimal var
    ...
    begin
        ...
        if DetailedGSTLedgEntry.FindSet()then repeat if(DetailedGSTLedgEntry."GST Component Code" = 'IGST')then IGSTAmount+=(DetailedGSTLedgEntry."GST Amount");
                if(DetailedGSTLedgEntry."GST Component Code" = 'CGST')then CGSTAmount+=(DetailedGSTLedgEntry."GST Amount");
                if(DetailedGSTLedgEntry."GST Component Code" = 'SGST')then SGSTAmount+=(DetailedGSTLedgEntry."GST Amount");
                if(DetailedGSTLedgEntry."GST Component Code" = 'Cess')then CESSAmount+=(DetailedGSTLedgEntry."GST Amount");
    ...
    begin
        ...
        while GSTR2ATQuery.Read()do begin
            ...
            if GSTR2ATQuery.GST_Component_Code = CessLbl then TempExcelBuffer.AddColumn(GSTR2ATQuery.GST_Amount, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
            GSTR2ATQuery.Close();
        end;
        ...
        GSTR2ATQuery.SetRange(GST__, 18);
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do GSTBaseAmtInters:=GetBaseAmountforPaymentType(GSTR2ATQuery.Document_No_);
        if GSTBaseAmtInters <> 0 then TempExcelBuffer.AddColumn(Abs(GSTBaseAmtInters), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        GSTR2ATQuery.Close();
    ...
    begin
        ...
        GSTR2ATQuery.SetRange(GST__, 9);
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do GSTBaseAmtIntras:=GetBaseAmountforPaymentType(GSTR2ATQuery.Document_No_);
        if GSTBaseAmtIntras <> 0 then TempExcelBuffer.AddColumn(Abs(GSTBaseAmtIntras), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        GSTR2ATQuery.Close();
    ...
    begin
        ...
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do CreateExcelBodyATIntra(GSTR2ATQuery);
    end;
    ...
    begin
        ...
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do FillExcelBodyAT(GSTR2ATQuery);
    end;
    ...
    begin
        ...
        GSTR2Exemp.Open();
        while GSTR2Exemp.Read()do GSTBaseAmt:=GetPurchaseValue(GSTR2Exemp.Document_No_);
        GSTR2Exemp.Close();
        TempExcelBuffer.NewRow();
    ...
    begin
        ...
        GSTR2Exemp.SetRange(Posting_Date, StartDate, EndDate);
        GSTR2Exemp.SetRange(GST_Jurisdiction_Type, "GST Jurisdiction Type"::Intrastate);
        GSTR2Exemp.SetFilter(GST_Vendor_Type, '%1|%2', "GST Vendor Type"::Registered, "GST Vendor Type"::Unregistered);
        GSTR2Exemp.SetFilter(Document_Type, '%1|%2', "GST Document Type"::Invoice, "GST Document Type"::"Credit Memo");
    ...
    begin
        ...
        if PurchInvHeader.FindSet()then repeat PurchInvLine.Reset();
                ...
                if PurchInvLine.FindSet()then repeat GSTBaseAmount1:=GetPurchaseValueforNonGstSupplies(PurchInvLine."Document No.");
        ...
        if PurchCrMemoHdr.FindSet()then repeat PurchCrMemoLine.Reset();
                ...
                if PurchCrMemoLine.FindSet()then repeat GSTBaseAmount:=GetPurchaseValueforNonGstSupplies(PurchCrMemoLine."Document No.");
                    until PurchCrMemoLine.Next() = 0;
            until PurchCrMemoHdr.Next() = 0;
        if GSTBaseAmount <> 0 then TempExcelBuffer.AddColumn(GSTBaseAmount, false, '', true, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        else
    ...
    local procedure GetPurchaseValue(DocumentNo: Text): Decimal var
        PurchInvHeader: Record "Purch. Inv. Header";
        PurchInvLine: Record "Purch. Inv. Line";
        PurchCrMemoHdr: Record "Purch. Cr. Memo Hdr.";
        PurchCrMemoLine: Record "Purch. Cr. Memo Line";
    begin
        PurchInvHeader.Reset();
        PurchInvHeader.SetRange("No.", DocumentNo);
        IF PurchInvHeader.FindFirst()THEN if DocumentNumber <> DocumentNo then begin
                PurchInvLine.Reset();
                PurchInvLine.SETRANGE("Document No.", PurchInvHeader."No.");
                IF PurchInvLine.FINDSET()THEN REPEAT case PurchInvLine."GST Jurisdiction Type" of "GST Jurisdiction Type"::Intrastate: PurchaseIntraAmt+=PurchInvLine."Line Amount";
                        "GST Jurisdiction Type"::Interstate: PurchaseInterAmt+=PurchInvLine."Line Amount";
                        end;
                    UNTIL PurchInvLine.NEXT() = 0;
                PurchInvLine.Reset();
                PurchInvLine.SETRANGE("Document No.", PurchInvHeader."No.");
        ...
        IF PurchCrMemoHdr.FindFirst()then if DocumentNumber <> DocumentNo then begin
                PurchCrMemoLine.Reset();
                PurchCrMemoLine.SETRANGE("Document No.", PurchCrMemoHdr."No.");
                IF PurchCrMemoLine.FINDSET()then REPEAT case PurchCrMemoLine."GST Jurisdiction Type" of "GST Jurisdiction Type"::Intrastate: PurchaseIntraAmt-=PurchCrMemoLine."Line Amount";
                        "GST Jurisdiction Type"::Interstate: PurchaseInterAmt-=PurchCrMemoLine."Line Amount";
                        end;
                    UNTIL PurchCrMemoLine.NEXT() = 0;
            end;
        PurchCrMemoLine.Reset();
    ...
    local procedure GetPurchaseValueforNonGstSupplies(DocumentNo: Text): Decimal var
        PurchInvHeader: Record "Purch. Inv. Header";
        PurchInvLine: Record "Purch. Inv. Line";
        PurchCrMemoHdr: Record "Purch. Cr. Memo Hdr.";
        PurchCrMemoLine: Record "Purch. Cr. Memo Line";
    begin
        ...
        if PurchInvLine.FindFirst()then if PurchInvLine."GST Jurisdiction Type" = PurchInvLine."GST Jurisdiction Type"::Interstate then begin
                DocumentNumber:=DocumentNo;
                exit(PurchaseInterAmt);
            end
            else
        ...
        if PurchCrMemoLine.FindFirst()then if PurchCrMemoLine."GST Jurisdiction Type" = PurchCrMemoLine."GST Jurisdiction Type"::Interstate then begin
                DocumentNumber:=DocumentNo;
                exit(PurchaseInterAmt);
            end
            else
    ...
    begin
        GSTR2ATQuery.SetRange(GST__, 18);
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do if GSTR2ATQuery.Buyer_Seller_State_Code <> '' then begin
                TempExcelBuffer.NewRow();
                State.Get(GSTR2ATQuery.Buyer_Seller_State_Code);
                TempExcelBuffer.AddColumn(State."State Code (GST Reg. No.)" + '-' + State.Description, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
                TempExcelBuffer.AddColumn(GSTR2ATQuery.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        ...
        Clear(GSTBaseAmtInter);
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do GSTBaseAmtInters:=GSTBaseAmount(GSTR2ATQuery.Original_Doc__No_, GSTR2ATQuery.Document_No_);
        if GSTBaseAmtInters <> 0 then TempExcelBuffer.AddColumn(Abs(GSTBaseAmtInters), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        GSTR2ATQuery.Close();
        GSTR2ATQuery.SetRange(GST__, 12);
        GSTR2ATQuery.Open();
    ...
    begin
        ...
        GSTR2ATQuery.SetRange(GST__, 9);
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do GSTBaseAmtIntras:=GSTBaseAmount(GSTR2ATQuery.Original_Doc__No_, GSTR2ATQuery.Document_No_);
        if GSTBaseAmtIntras <> 0 then TempExcelBuffer.AddColumn(Abs(GSTBaseAmtIntras), false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        GSTR2ATQuery.Close();
        GSTR2ATQuery.SetRange(GST__, 6);
        GSTR2ATQuery.Open();
    ...
    begin
        ...
        GSTR2ATQuery.SetRange(GST_Component_Code, CGSTLbl);
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do CreateExcelBodyATADJIntra(GSTR2ATQuery);
    end;
    ...
    begin
        ...
        GSTR2ATQuery.SetRange(GSTR2ATQuery.GST_Jurisdiction_Type, "GST Jurisdiction Type"::Interstate);
        GSTR2ATQuery.Open();
        while GSTR2ATQuery.Read()do CreateExcelBodyATADJ(GSTR2ATQuery);
    end;
    local procedure GSTBaseAmount(OriginalDocNo: Text; DocumentNo: Text): Decimal var
        DetailedGstLedgerEntry: Record "Detailed GST Ledger Entry";
        VendorLedgerEntry: Record "Vendor Ledger Entry";
    begin
        ...
        if VendorLedgerEntry.FindFirst()then begin
            ...
            if DetailedGstLedgerEntry.FindFirst()then case DetailedGstLedgerEntry."GST Jurisdiction Type" of "GST Jurisdiction Type"::Intrastate: begin
                    GSTBaseAmtIntra+=DetailedGstLedgerEntry."GST Base Amount";
                    exit(GSTBaseAmtIntra);
                end;
                "GST Jurisdiction Type"::Interstate: begin
        ...
        DetailedGstLedgerEntry.SetRange("Document No.", DocumentNo);
        DetailedGstLedgerEntry.SetRange("Entry Type", DetailedGstLedgerEntry."Entry Type"::Application);
        if DetailedGstLedgerEntry.FindFirst()then case DetailedGstLedgerEntry."GST Jurisdiction Type" of "GST Jurisdiction Type"::Intrastate: exit(GSTBaseAmtIntra);
            "GST Jurisdiction Type"::Interstate: exit(GSTBaseAmtInter);
            end;
    end;
    local procedure GetBaseAmountforPaymentType(DocumentNo: Text): Decimal var
        DetailedGstLedgerEntry: Record "Detailed GST Ledger Entry";
    begin
        DetailedGstLedgerEntry.Reset();
        DetailedGstLedgerEntry.SetRange("Document No.", DocumentNo);
        if DetailedGstLedgerEntry.FindFirst()then if(DetailedGstLedgerEntry."Document Type" = DetailedGstLedgerEntry."Document Type"::Payment)then case DetailedGstLedgerEntry."GST Jurisdiction Type" of "GST Jurisdiction Type"::Intrastate: begin
                    GSTBaseAmtIntra+=DetailedGstLedgerEntry."GST Base Amount";
                    exit(GSTBaseAmtIntra);
                end;
                "GST Jurisdiction Type"::Interstate: begin
    ...
    begin
        ...
        GSTR2HSNQuery.Open();
        while GSTR2HSNQuery.Read()do CreateExcelBufferHSNSUM(GSTR2HSNQuery);
    end;
    ...
    begin
        ...
        GSTR2HSNGSTAmt.Open();
        while GSTR2HSNGSTAmt.Read()do HSNCGSTAmt:=GSTR2HSNGSTAmt.GST_Amount;
        GSTR2HSNGSTAmt.SetRange(GST_Component_Code, SGSTLbl);
        GSTR2HSNGSTAmt.Open();
        while GSTR2HSNGSTAmt.Read()do HSNSGSTAmt:=GSTR2HSNGSTAmt.GST_Amount;
        GSTR2HSNGSTAmt.SetRange(GST_Component_Code, IGSTLbl);
        GSTR2HSNGSTAmt.Open();
        while GSTR2HSNGSTAmt.Read()do HSNIGSTAmt:=GSTR2HSNGSTAmt.GST_Amount;
        GSTR2HSNGSTAmt.SetRange(GST_Component_Code, CessLbl);
        GSTR2HSNGSTAmt.Open();
        while GSTR2HSNGSTAmt.Read()do HSNCessAmt:=GSTR2HSNGSTAmt.GST_Amount;
        ...
        GSTR2HSNQty.Open();
        while GSTR2HSNQty.Read()do if(GSTR2HSNQty.GST_Jurisdiction_Type = GSTR2HSNQty.GST_Jurisdiction_Type::Intrastate) and (GSTR2HSNQty.Document_Type In[(GSTR2HSNQty.Document_Type::Invoice), (GSTR2HSNQty.Document_Type::Payment), (GSTR2HSNQty.Document_Type::Refund)])then begin
                HSNQty+=GSTR2HSNQty.Quantity / 2;
                HSNGSTBaseAmt+=GSTR2HSNQty.GST_Base_Amount / 2;
            end
            else if(GSTR2HSNQty.GST_Jurisdiction_Type = GSTR2HSNQty.GST_Jurisdiction_Type::Interstate) and (GSTR2HSNQty.Document_Type In[(GSTR2HSNQty.Document_Type::Invoice), (GSTR2HSNQty.Document_Type::Payment), (GSTR2HSNQty.Document_Type::Refund)])then begin
                    HSNQty+=GSTR2HSNQty.Quantity;
                    HSNGSTBaseAmt+=GSTR2HSNQty.GST_Base_Amount;
                end
                else if(GSTR2HSNQty.GST_Jurisdiction_Type = GSTR2HSNQty.GST_Jurisdiction_Type::Intrastate) and (GSTR2HSNQty.Document_Type = GSTR2HSNQty.Document_Type::"Credit Memo")then begin
                        HSNQty:=HSNQty - GSTR2HSNQty.Quantity / 2;
                        HSNGSTBaseAmt+=GSTR2HSNQty.GST_Base_Amount / 2;
                    end
                    else if(GSTR2HSNQty.GST_Jurisdiction_Type = GSTR2HSNQty.GST_Jurisdiction_Type::Interstate) and (GSTR2HSNQty.Document_Type = GSTR2HSNQty.Document_Type::"Credit Memo")then begin
        ...
        if GSTR2HSNQuery.HSN_SAC_Code <> '' then TempExcelBuffer.AddColumn(GSTR2HSNQuery.Description, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text)
        else
            TempExcelBuffer.AddColumn('', false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Text);
