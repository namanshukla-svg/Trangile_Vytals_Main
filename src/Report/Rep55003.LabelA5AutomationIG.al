Report 55003 "Label - A5 Automation IG"
{
    DefaultLayout = RDLC;
        ...
        dataitem("Package Tracking"; "Package Tracking")
        {
            ...
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                begin
                    ...
                    //SSD_Sunil_110325
                    //IG_DS      // Clear(LocationCode);
                    // Clear(ItemLedgEntryNo);
                    // ItemLedgEntryNo := "Item Ledger Entry".GetFilter("Entry No.");
                    ...
                    //IG_DS       // SetRange("Lot No.", ItemLedgerEntry."Lot No.");
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    // {
                    //     ApplicationArea = all;
                    //     TableRelation = "Package Tracking"."Lot No.";
                    // }
                }
            }
        }
