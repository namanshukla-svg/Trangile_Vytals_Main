report 50039 "Sales Order Report - MIS New"
{
    ApplicationArea = All;
    Caption = 'Sales Order Report - MIS New';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    ItemCategory.Reset();
                    if ItemCategory.Get("Sales Line"."Item Category Code")then if ItemCategory."Parent Category" <> '' then ItemCategoryCode:=ItemCategory."Parent Category"
                        else
                            ItemCategoryCode:=''
                    else
                        ItemCategoryCode:='';
