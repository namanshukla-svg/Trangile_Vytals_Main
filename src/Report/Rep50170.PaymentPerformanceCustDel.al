Report 50170 "Payment Performance Cust. Del."
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Payment Performance Cust. Del..rdl';
        ...
        dataitem("Salesperson/Purchaser"; "Salesperson/Purchaser")
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                {
                    ...
                    column(Actual_Delevery_Date; Sales_Invoice_Header."Actual Delivery Date")
                    {
                    }
                    dataitem("Cust. Ledger Entry1"; "Cust. Ledger Entry")
                    {
                        ...
                        dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
                        {
                            ...
                            column(Actual_Date; Actual_Date)
                            {
                            }
                            ...
                            begin
                                ...
                                if(Sales_Invoice_Header."Actual Delivery Date" <> 0D) and ("Bank Account Ledger Entry"."Document Date" <> 0D)then //US 8/8/16
 Actual_Date:="Bank Account Ledger Entry"."Document Date" - Sales_Invoice_Header."Actual Delivery Date"; // US 1/8/16
                    ...
                    begin
                        Actual_Date:=0;
                        //...............Code Written By Umang For Actual Delivery Date..................
                        Sales_Invoice_Header.Reset;
                        Sales_Invoice_Header.SetRange("No.", "Document No.");
                        if Sales_Invoice_Header.FindFirst then;
                    //..............Code Ends Here Umang...........................................
                    end;
                }
                trigger OnAfterGetRecord()
                begin
