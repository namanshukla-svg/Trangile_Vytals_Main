Report 50280 "FG vs RM Requirement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/FG vs RM Requirement.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
                ...
                dataitem("Integer"; "Integer")
                {
                    ...
                    begin
                        ...
                        if DateRec.FindSet then repeat if I = 1 then begin
                                    ...
                                    ProductionForecastEntry.SetRange("Production Forecast Name", 'KEYPRDFORC');
                                    ...
                                    if ProductionForecastEntry.FindSet then repeat qty1+=ProductionForecastEntry."Forecast Quantity";
                                        //FGBomQuantityPer."Prod. Forecast M1" := ProductionForecastEntry."Forecast Quantity";
                                        until ProductionForecastEntry.Next = 0;
                                    FGBomQuantityPer."Prod. Forecast M1":=qty1;
                                end;
                                if I = 2 then begin
                                    Clear(TotalQTYM2);
                                    ...
                                    ProductionForecastEntry.SetRange("Forecast Date", DateRec."Period Start", DateRec."Period End");
                                    ProductionForecastEntry.SetRange("Item No.", Item."No.");
                                    if ProductionForecastEntry.FindSet then repeat qty2+=ProductionForecastEntry."Forecast Quantity";
                                        //FGBomQuantityPer."Prod. Forecast M2" := ProductionForecastEntry."Forecast Quantity";
                                        until ProductionForecastEntry.Next = 0;
                                    FGBomQuantityPer."Prod. Forecast M2":=qty2;
                                end;
                                if I = 3 then begin
                                    Clear(TotalQTYM3);
                                    ...
                                    ProductionForecastEntry.SetRange("Forecast Date", DateRec."Period Start", DateRec."Period End");
                                    ProductionForecastEntry.SetRange("Item No.", Item."No.");
                                    if ProductionForecastEntry.FindSet then repeat qty3+=ProductionForecastEntry."Forecast Quantity";
                                        //FGBomQuantityPer."Prod. Forecast M3" := ProductionForecastEntry."Forecast Quantity";
                                        until ProductionForecastEntry.Next = 0;
                                    FGBomQuantityPer."Prod. Forecast M3":=qty3;
                                end;
                                if I = 4 then begin
                                    Clear(TotalQTYM4);
                                    ...
                                    ProductionForecastEntry.SetRange("Forecast Date", DateRec."Period Start", DateRec."Period End");
                                    ProductionForecastEntry.SetRange("Item No.", Item."No.");
                                    if ProductionForecastEntry.FindSet then repeat qty4+=ProductionForecastEntry."Forecast Quantity";
                                        //FGBomQuantityPer."Prod. Forecast M4" := ProductionForecastEntry."Forecast Quantity";
                                        until ProductionForecastEntry.Next = 0;
                                    FGBomQuantityPer."Prod. Forecast M4":=qty4;
                                end;
                                I+=1;
            ...
            begin
                ...
                "End Date":=CalcDate('4M', "Start Date");
