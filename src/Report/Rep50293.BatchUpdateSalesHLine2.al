Report 50293 "Batch Update Sales H & Line_2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Batch Update Sales H & Line_2.rdl';
    UseRequestPage = true;
                ...
                if CreateSalesOrder("Distributor Line") then begin
                    if DistributionHeader_G.Updated = true then begin
                        ...
                        if SalesHeader2.FindSet then
                            repeat
                                AlleEvents.SendMailOnSalesOrderCreate(SalesHeader2."No.", "Distributor Line"."SP Order No."); //SSD Uncomment
