Report 50278 "Inventory Valuation>01042020"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Inventory Valuation01042020.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            DataItemTableView = sorting("Inventory Posting Group")where(Type=const(Inventory), "No."=filter(<>'FG0002091'));
