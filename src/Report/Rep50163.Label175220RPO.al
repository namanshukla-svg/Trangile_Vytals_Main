Report 50163 "Label - 175 * 220 - RPO"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Label - 175  220 - RPO.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        ...
        {
            // MaxIteration = 1;
            RequestFilterFields = "Entry No.", "Source ID", "Item No.", "Lot No.", "Package No.";
            ...
            begin
                ...
                //IG_DS
                QRCodeInput := "Reservation Entry"."Package No.";
