Report 50168 "Label - A5 - RPO Test 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Label - A5 - RPO Test 2.rdlc';
    ApplicationArea = all;
    UsageCategory = ReportsAndAnalysis;

    dataset
    {
        dataitem(Barcode2; "SSD Barcode Labelpp")
        {
            DataItemTableView = sorting(SrNo)order(ascending);

            column(ReportForNavId_1000000038;1000000038)
            {
            }
            column(SrNo_Barcode; Barcode2.SrNo)
            {
            }
            dataitem("Reservation Entry"; "Reservation Entry")
            {
                ...
                begin
                    ...
                    NetWT:=Barcode2."Net Weight";
                    GrossWT:=Barcode2."Gross Weight";
                    QtyPrint:=Barcode2.Quantity;
                    Item.Get("Item No.");
