Report 50362 "Sales Statistics New"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Sales Statistics.rdl';
    Caption = 'Sales Statistics New';
    ApplicationArea = all;
        ...
        dataitem(Customer; Customer)
        {
            ...
            begin
                ...
                for i:=1 to 5 do begin
                    ...
                    CalcFields("Sales (LCY)", "Profit (LCY)", "Inv. Discounts (LCY)", "Pmt. Discounts (LCY)", "Pmt. Disc. Tolerance (LCY)", "Pmt. Tolerance (LCY)");
                    ...
                    if(CustSalesLCY[i] <> 0) or (CustProfitLCY[i] <> 0) or (CustInvDiscAmountLCY[i] <> 0) or (CustPaymentDiscLCY[i] <> 0) or (CustPaymentDiscTolLCY[i] <> 0) or (CustPaymentTolLCY[i] <> 0)then PrintCust:=true;
                end;
            ...
            begin
                for i:=1 to 5 do begin
                    CurrReport.CreateTotals(CustSalesLCY[i], CustProfitLCY[i], AdjmtCostLCY[i], AdjCustProfitLCY[i], CustInvDiscAmountLCY[i], CustPaymentDiscLCY[i], CustPaymentDiscTolLCY[i], CustPaymentTolLCY[i]);
                end;
            end;
        }
    }
