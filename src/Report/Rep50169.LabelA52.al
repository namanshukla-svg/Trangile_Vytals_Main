Report 50169 "Label - A5 --2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Label - A5 --2.rdlc';
    UsageCategory = Lists;
    ApplicationArea = all;

    dataset
    {
        dataitem(Barcode; "SSD Barcode Labelpp")
        {
            ...
            column(SrNo_BarcodeLabelpp; SrNo)
            {
            }
            dataitem("Item Ledger Entry"; "Item Ledger Entry")
            {
                ...
                column(ItemLedgerEntryExpirationDate; "Item Ledger Entry"."Expiration Date")
                {
                }
