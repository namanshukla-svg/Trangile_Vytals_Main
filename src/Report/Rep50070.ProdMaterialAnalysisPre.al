Report 50070 "Prod. Material Analysis-Pre"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Prod. Material Analysis-Pre.rdl';
    ...
    dataset
    {
        dataitem("Quality Order Header"; "SSD Quality Order Header")
        {
            ...
            RequestFilterFields = "No.", "Source Document No.", "Order No.";
            ...
            dataitem("Quality Order Line"; "SSD Quality Order Line")
            {
                ...
                column(Quality_Order_Line__Quality_Order_Line___Unit_of_Measure_Code__Control1000000053; "Quality Order Line"."Unit of Measure Code")
                {
                }
                column(QualityMeasurements_Protocol_Control1000000054; QualityMeasurements.Protocol)
                {
                }
                column(Quality_Order_Line_Description_Control1000000055; Description)
                {
                }
            ...
            begin
                ...
                Vendor.Reset;
                if Vendor.Get("Quality Order Header"."Source Code")then;
                MachineCentre.Reset;
                if MachineCentre.Get("Quality Order Header"."W.C. / M.C. No.")then;
            end;
        }
    }
    requestpage
    ...
    begin
        fixedtext:='FM-QA-03, Rev.No.00, Effective Date 13/10/2005';
    end;
    trigger OnPreReport()
    begin
        CompInfo.Get;
