Report 50171 "Sales Invoice new_"
{
    DefaultLayout = RDLC;
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            */
                            ...
                            //             PackDesc[PackCounter] := ItemLedgerEntry."Package No.";//+ ' ' + Item.package type;//SSD_UnComment
                            //             PackDescQty[PackCounter] := Format(ItemLedgerEntry.Quantity) + ' ' + ItemLedgerEntry."Unit of Measure Code";
                            //             PackCounter += 1;
                            //         end;
