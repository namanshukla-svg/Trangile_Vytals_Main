Report 50344 "Zavenir Stock Statment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Zavenir Stock Statment.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            column(DataItem1000000000; respcent.Address + ',' + respcent."Address 2" + ',' + respcent.City + '-' + respcent."Post Code" + ',' + respcent.State + 'TEL No. ' + respcent."Phone No." + ' FAX No. ' + respcent."Fax No.")
            {
            }
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("Item Ledger Entry"; "Item Ledger Entry")
                {
                    ...
                    column(Item_Description_________Item__Description_2_; Item.Description)
                    {
                    }
                    column(Item__No__; Item."No.")
                    {
                    }
                    column(ItemOnHand; ClosingQtyG)
                    {
                    DecimalPlaces = 0: 5;
                    }
                    ...
                    column(StartOnHand; OpeningQtyG)
                    {
                    DecimalPlaces = 0: 5;
                    }
                    ...
                    begin
                        ...
                        if OpeningBoolean then begin
                            ...
                            RunningQty:=StartOnHand;
                            OpeningBoolean:=false;
                        end;
                        if ItemOnHand <> 0 then StartOnHand:=ItemOnHand
                        else
                            ItemOnHand:=StartOnHand;
                        // IF StartOnHand > 0 THEN BEGIN
                        //  RunningQty += "Item Ledger Entry".Quantity;
                        //  StartOnHand := RunningQty;
                        // END ELSE IF StartOnHand < 0 THEN BEGIN
                        //  RunningQty += "Item Ledger Entry".Quantity;
                        //  StartOnHand := RunningQty;
                        // END ELSE
                        //  StartOnHand := 0;
                        ...
                        OpeningQtyG:=ClosingQtyG;
                        ClosingQtyG+="Item Ledger Entry".Quantity;
                    end;
            ...
            begin
                ...
                if ItemDateFilter <> '' then if GetRangeMin("Date Filter") > 00000101D then begin
                        ...
                        OpeningQtyG:=ILE.Quantity;
                        StartOnHand:=ILE.Quantity;
                    end;
                ClosingQtyG:=OpeningQtyG;
