Report 50137 "ItemSamplingTemplDesc_LIVE"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ItemSamplingTemplDesc_LIVE.rdl';
    ...
    dataset
    {
        dataitem("Integer"; "Integer")
        {
            ...
            begin
                ...
                SamplingtestHeader.Reset;
                if SamplingtestHeader.FindFirst then repeat begin
                        Item.Reset;
                        if Item.Get(SamplingtestHeader."No.")then SamplingtestHeader.Description:=Item.Description;
                        //SamplingtestHeader."Description 2":=Item."Description 2";
                        SamplingtestHeader.Modify;
                    end;
                    until SamplingtestHeader.Next = 0;
            end;
        }
    }
    requestpage
