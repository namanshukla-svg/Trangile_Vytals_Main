Report 50350 "Trial Balance/Budget New"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Trial BalanceBudget.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                if "Budgeted Amount" = 0 then DiffPct:=0
                else
                    DiffPct:="Net Change" / "Budgeted Amount" * 100;
                if GLAcc2."Budget at Date" = 0 then DiffAtDatePct:=0
                else
