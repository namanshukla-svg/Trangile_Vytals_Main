report 50486 "Daywise Inv. & Return - Key"
{
    ApplicationArea = All;
    Caption = 'Daywise Invoice & Return - Key Report';
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                PostedSalesInvoices.SetRange(PostedSalesInvoices.Category_SalespersonPurchaser, PostedSalesInvoices.Category_SalespersonPurchaser::"Key");
                ...
                while PostedSalesInvoices.Read()do begin
                    ...
                    SalesReturnOrders.SetRange(SalesReturnOrders.Category, SalesReturnOrders.Category::"Key");
