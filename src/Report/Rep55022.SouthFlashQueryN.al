report 55022 "South Flash Query N"
{
    ApplicationArea = All;
    Caption = 'South Flash N';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/55010_SouthFlashQueryN.rdl';
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                PoolUpdate1.SetRange(PoolUpdate1.Sales_Region, PoolUpdate1.Sales_Region::South);
                PoolUpdate1.Open();
                ...
                Clear(PoolUpdate2);
                PoolUpdate2.SetRange(PoolUpdate2.Order_Date, StartDate, EndDate);//IG_DS StartDate1, EndDate1);
                PoolUpdate2.SetRange(PoolUpdate2.Sales_Region, PoolUpdate2.Sales_Region::South);
                PoolUpdate2.Open();
                ...
                PoolUpdate2A.SetRange(PoolUpdate2A.Sales_Region, PoolUpdate2A.Sales_Region::South);
                PoolUpdate2A.Open();
                ...
                PoolUpdate3.SetRange(PoolUpdate3.Sales_Region, PoolUpdate3.Sales_Region::South);
                PoolUpdate3.Open();
    ...
    var
        SSDPoolUpdateTable: Record SSDPoolUpdateTableNN;
        SSDPoolUpdateTableRec: Record SSDPoolUpdateTableNN;
        PoolUpdate1: Query PoolUpdate1N;
        PoolUpdate2: Query PoolUpdate2NN;
        PoolUpdate2A: Query PoolUpdate2NN;
