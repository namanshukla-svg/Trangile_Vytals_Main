Report 50167 "BARCODE LEBEL RECEIPT 4x6-Post"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/BARCODE LEBEL RECEIPT 4x6-Post.rdl';
        ...
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            dataitem("Barcode Labelpp"; "SSD Barcode Labelpp")
            {
                ...
                dataitem("QR Code Str"; "SSD QR Code Str")
                {
                    ...
                    column(QRCode; "QR Code Str".QRCode)
                    {
                    }
                }
                ...
                begin
                    Clear(QRCodeMgt);
                    Clear(QRCodeStr);
                    QRCodeMgt.BarcodeForReservationEntry1("Item Ledger Entry"."Document No.", "Item Ledger Entry"."Lot No.", "Item Ledger Entry"."Item No.", "Item Ledger Entry"."Location Code", "Barcode Labelpp".Quantity, "Barcode Labelpp".SrNo);
                    //IF QRCodeStr.FINDSET THEN;
