report 50485 "Channel- Sales Flash Query"
{
    ApplicationArea = All;
    Caption = 'Channel - Sales Flash';
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/50485_ChannelSalesFlashQuery.rdl';
    ...
    dataset
    {
        dataitem(Integer; Integer)
        {
            ...
            begin
                ...
                PoolUpdate1.SetRange(PoolUpdate1.Category, PoolUpdate1.Category::Channel);
                PoolUpdate1.Open();
                ...
                PoolUpdate2.SetRange(PoolUpdate2.Category, PoolUpdate2.Category::Channel);
                PoolUpdate2.Open();
                ...
                PoolUpdate3.SetRange(PoolUpdate3.Category, PoolUpdate3.Category::Channel);
                PoolUpdate3.Open();
