Report 50191 "Credit Note Report"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            RequestFilterHeading = 'Posted Sales Cr. Memos';

            column(CompanyInfoRec_Picture; CompanyInfoRec.Picture)
            {
            }
            column(CompanyName; 'For' + '  ' + CompanyInfoRec.Name)
            {
            }
            ...
            column(InvNoNew; "Sales Cr.Memo Header"."No.")
            {
            }
            ...
            // {
            // }    //SSDVG
            column(Sales_Invoice_Line__Amount; "Sales Cr.Memo Line".Amount)
            {
            }
            // column(Sales_Invoice_Line___BED_Amount_;"Sales Cr.Memo Line"."BED Amount")
            // {
            // }
            // column(Sales_Invoice_Line___SHE_Cess_Amount_;"Sales Cr.Memo Line"."SHE Cess Amount")
            // {
            // }
            // column(Sales_Invoice_Line___eCess_Amount_;"Sales Cr.Memo Line"."eCess Amount")
            // {
            // }
            // column(Sales_Invoice_Line__Amount__Sales_Invoice_Line___Excise_Amount_;"Sales Cr.Memo Line".Amount+"Sales Cr.Memo Line"."Excise Amount")
            // {
            // }
            column(FreightAmt; FreightAmt)
            {
            }
            // column(Sales_Invoice_Line___Tax_Amount_;"Sales Cr.Memo Line"."Tax Amount")
            // {
            //     DecimalPlaces = 2:2;
            // }
            ...
            // column(Sales_Invoice_Line___Amount_To_Customer__SaleInvLine__Line_Amount_;"Sales Cr.Memo Line"."Amount To Customer"+SaleInvLine."Line Amount")
            // {
            // }
            // column(Sales_Invoice_Header__Sales_Invoice_Header___Vehicle_No__; "Sales Cr.Memo Line"."Vehicle No.")
            // {
            // }//SSDVG
            ...
            column(Sales_Invoice_Header__ST38_No_; "Sales Cr.Memo Header"."E-Way Bill No.")
            {
            }
            ...
            column(Sales_Invoice_Header___Sell_to_Customer_No__; "Sales Cr.Memo Header"."Sell-to Customer No.")
            {
            }
            ...
            column(Sales_Invoice_Header___Sell_to_Customer_No__Caption; "Sales Cr.Memo Header".FieldCaption("Sell-to Customer No."))
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                column(ReportForNavId_1000000212; ReportCopyName)
                {
                }
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Sales_Invoice_Header___Posting_Date_; Format("Sales Cr.Memo Header"."Posting Date"))
                    {
                    }
                    ...
                    column(OrderNoNew_______FORMAT__Sales_Invoice_Header___Order_Date__; OrderNoNew + '/ ' + Format("Sales Cr.Memo Header"."Document Date"))
                    {
                    }
                    column(Sales_Invoice_Header___Ship_to_City_; "Sales Cr.Memo Header"."Ship-to City" + ' (' + reccust."State Code" + '-' + RecState."State Code (GST Reg. No.)" + ')')
                    {
                    }
                    ...
                    column(Sales_Invoice_Header___External_Document_No__; "Sales Cr.Memo Header"."External Document No.")
                    {
                    }
                    column(Sales_Invoice_Header___External_Doc__Date_; "Sales Cr.Memo Header"."Document Date")
                    {
                    } //SSDVG
                    ...
                    dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        column(LineNo_SalesInvoiceLine; "Sales Cr.Memo Line"."Line No.")
                        {
                        }
                        column(AmountInWords; AmountInWords[1])
                        {
                        }
                        column(ShipmentDate_SalesInvoiceLine; "Sales Cr.Memo Line"."Shipment Date")
                        {
                        }
                        ...
                        // column(GSTBaseAmount_SalesInvoiceLine;"Sales Cr.Memo Line"."GST Base Amount")
                        // {
                        // }
                        ...
                        // {
                        // }
                        column(Sales_Invoice_Line_Description_Control65; "No." + '-' + desc) // + '  '// + "Sales Cr.Memo Line"."Description 2")//SSDVG
                        {
                        }
                        ...
                        column(Sales_Invoice_Line__Description_2_; desc2)
                        {
                        }
                        ...
                        column(FORMAT_ROUND_Item2__Net_Weight___Sales_Invoice_Line__Quantity_0_01_________KGS___; '( ' + Format(ROUND(Item2."Net Weight" * "Sales Cr.Memo Line".Quantity, 0.01, '=')) + ' KGS )')
                        {
                        }
                        ...
                        column(Sales_Invoice_Header___VAT_Base_Discount___; "Sales Cr.Memo Header"."VAT Base Discount %")
                        {
                            AutoFormatType = 1;
                        }
                        ...
                        begin
                            ...
                            if "Invoice Type" = "Invoice Type"::Supplementary then begin
                                ...
                                TaxTransactionValue.SetRange("Tax Record ID", "Sales Cr.Memo Line".RecordId);
                                ...
                                DetailedGSTLedgerEntry1.SetRange("Document No.", "Sales Cr.Memo Header"."No.");
                            ...
                            XX := XX - 1;
                            desc := '';
                            desc := "Sales Cr.Memo Line".Description;
                            desc2 := "Sales Cr.Memo Line"."Description 2";
                            //Alle_190419-begin
                            ...
                            */
                            ...
                            // // DespLine.SetRange("Document No.", "Sales Cr.Memo Line"."Despatch Slip No.");//SSDVG
                            ...
                            //<<<< ALLE[551]
                            CrossRefValue := '';
                            if Item2.Get("Sales Cr.Memo Line"."No.") then;
                            CrossRefValue := '( ' + Format(ROUND(Item2."Net Weight" * "Sales Cr.Memo Line".Quantity, 0.01, '=')) + ' KGS )';
                            ...
                            // // SalesScheduleBuffer.SetRange("Document No.", "Sales Cr.Memo Line"."Despatch Slip No.");
                            // // SalesScheduleBuffer.SetRange("Order Line No.", "Sales Cr.Memo Line"."Despatch Slip Line No.");//SSDVG
                            ...
                            //         PackCounter += 1;
                            //     // PackingSlipNo := "Sales Invoice Line"."Despatch Slip No.";//SSDVG
                ...
                begin
                    ...
                    CurrReport.PageNo := 1;
                    if OutputNo = 1 then
                        ReportCopyName := 'ORIGINAL COPY'
                    else if OutputNo = 2 then
                        ReportCopyName := 'DUPLICATE COPY'
                    else if OutputNo = 3 then ReportCopyName := 'TRIPLICATE COPY';
                    if ISSERVICETIER then begin
                        TotalSubTotal := 0;
            ...
            begin
                ...
                TCS_Amount := 0;
                TCSEntry.Reset();
                TCSEntry.SetRange("Document No.", "Sales Cr.Memo Header"."No.");
                ...
                EInvoicingRequest.SetRange("Document No.", "Sales Cr.Memo Header"."No.");
                EInvoicingRequest.SetRange("E-Invoice Generated", true);
                if EInvoicingRequest.FindFirst then EInvoicingRequest.CalcFields("QR Image");
                //CORP::PK 250819 >>>
                Clear(QRCodeMgt);
                Clear(QRCodeStr);
                QRCodeMgt.BarcodeForCrMemo("Sales Cr.Memo Header"."No.", "Sales Cr.Memo Header"."Posting Date", CopyStr("External Document No.", 1, 20), "Sales Cr.Memo Header"."Sell-to Customer Name");
                ...
                //SSDVG   // if StrLen("Sales Invoice Header"."Order/Scd. No.") > 5 then
                ...
                //SSDVG  //>>> ALLE[551]
                if BillTo.Get("Sales Cr.Memo Header"."Bill-to Customer No.") then;
                ...
                if reccust1.Get("Sales Cr.Memo Header"."Bill-to Customer No.") then;
                RecSIL.Reset;
                ...
                //>> Alle VPB
                Clear(CustAddr);
                if not StateRec.Get("Sales Cr.Memo Header".State) then StateRec.Init;
                CustAddr[1] := "Sales Cr.Memo Header"."Bill-to Name" + '  (' + "Sales Cr.Memo Header"."Bill-to Customer No." + ')';
                CustAddr[2] := "Sales Cr.Memo Header"."Bill-to Address";
                CustAddr[3] := "Sales Cr.Memo Header"."Bill-to Address 2";
                CustAddr[4] := "Sales Cr.Memo Header"."Bill-to City" + ', ' + StateRec.Description + ', ' + "Sales Cr.Memo Header"."Bill-to Post Code";
                //<<Alle VPB
                if not Cust.Get("Bill-to Customer No.") then Clear(Cust);
                //  QRMng.SaleInv(true, "Sales Cr.Memo Header", false, PurchCrMemoHdr);
                // QRMng.Run(ILE);
                Cust3.Get("Sales Cr.Memo Header"."Sell-to Customer No.");
                ...
                if CustLocal."Print Ship to Addr. on Inv." then begin
                    StateRec.Init;
                    if not StateRec.Get("Sales Cr.Memo Header"."GST Bill-to State Code") then ShipToAddr[2] := "Sales Cr.Memo Header"."Ship-to Address";
                    ShipToAddr[3] := "Sales Cr.Memo Header"."Ship-to Address 2";
                    ShipToAddr[1] := "Sales Cr.Memo Header"."Ship-to Name";
                    ShipToAddr[4] := "Sales Cr.Memo Header"."Ship-to City" + ', ' + StateRec.Description + ', ' + "Sales Cr.Memo Header"."Ship-to Post Code";
                ...
                if "Ship-to Code" = '' then begin
                    PlaceOfDelivery := "Sales Cr.Memo Header"."Ship-to City" + ' (' + reccust."State Code" + '-' + RecState."State Code (GST Reg. No.)" + ')';
                    PlaceOfSupply := "Sales Cr.Memo Header"."Bill-to City" + ' (' + reccust."State Code" + '-' + RecState."State Code (GST Reg. No.)" + ')';
                end
                else begin
                    if ShipToAdd.Get("Sell-to Customer No.", "Ship-to Code") then begin
                        ...
                        if RecState1.Get(ShipToAdd.State) then PlaceOfDelivery := "Sales Cr.Memo Header"."Ship-to City" + ' (' + ShipToAdd.State + '-' + RecState1."State Code (GST Reg. No.)" + ')';
                        PlaceOfSupply := "Sales Cr.Memo Header"."Bill-to City" + ' (' + reccust."State Code" + '-' + RecState."State Code (GST Reg. No.)" + ')';
                    end;
                end;
                //Alle 310717>>
                ...
                */
                //SSDVG  // OrderDate := "Order Date";
                // if SHL.Get(SHL."document type"::Order, "Order/Scd. No.") then
                //     OrderDate := SHL."Order Date";
                //<<Alle VPB
                ...
                */
                ...
                //SSDVG       // if "CT2 Form" <> '' then
                //     Comments[1] += 'CT2 Form: ' + "CT2 Form";
                // if "CT3 Form" <> '' then
                //     Comments[1] += 'CT3 Form: ' + "CT3 Form";
                AREDetails.Reset;
    ...
    var
        ...
        LanguageCode: Record Language; //IG_DS_after
        ...
        Ecess: Text[100];
        SHE: Text[100];
        SaleInvLine: Record "Sales Cr.Memo Line";
        TaxText: Text[100];
        ...
        Authorize_signatoryLbl: Label 'Authorised Signatory'; //SSDVG
        Checked_byLbl: Label 'Checked By'; //SSDVG
        ...
        Invoice_No_CaptionLbl: label 'Debit Note No.';
        ...
        RecSIL: Record "Sales Cr.Memo Line";
    ...
    //     //         exit(SalesShipmentHeader."Posting Date");//SSDVG
    //     // if "Sales Invoice Header"."Order No." = '' then
    //     //     exit("Sales Invoice Header"."Posting Date");//SSDVG
    ...
    begin
        ...
        // SalesInvoiceHeader.SetRange("Order No.", "Sales Invoice Header"."Order No.");//SSDVG
        ...
        //     SalesShipmentLine.SetRange("Order No.", "Sales Cr.Memo Header"."No.");//SSDVG
        ...
        //             //     CorrectShipment(SalesShipmentLine);//SSDVG
        ...
        //                 end;
        //             end;
        //         until (SalesShipmentLine.Next = 0) or (TotalQuantity = 0);//SSDVG
    end;
