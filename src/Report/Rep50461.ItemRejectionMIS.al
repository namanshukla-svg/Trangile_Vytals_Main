report 50461 "Item Rejection - MIS"
{
    ApplicationArea = All;
    Caption = 'Item Rejection - MIS';
    ...
    begin
        ...
        ExcelBuffer.AddColumn('Remaining Quantity', false, '', true, false, true, '', ExcelBuffer."cell type"::Text);
        ExcelBuffer.AddColumn('MSL', false, '', true, false, true, '', ExcelBuffer."cell type"::Text);
        ExcelBuffer.AddColumn('Value Remaining Quantity', false, '', true, false, true, '', ExcelBuffer."cell type"::Text);
    end;
    Local procedure CreateExcelBook();
    begin
        ExcelBuffer.CreateNewBook('Item Rejection - MIS');
        ExcelBuffer.WriteSheet('Item Rejection - MIS', CompanyName, UserId);
        ExcelBuffer.CloseBook();
        ExcelBuffer.SetFriendlyFilename('Item Rejection - MIS');
