Report 50014 "NEFT Document-Pre"
{
    // ALLE 2.15....NEFT/RTGS
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/NEFT Document-Pre.rdlc';
    UsageCategory = Lists;
    ApplicationArea = all;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Journal Template Name", "Journal Batch Name", "Posting Date", "Document No.")where("Transfer Type"=filter(NEFT), "Vendor Bank Account"=filter(<>''), "NEFT / RTGS Code"=filter(<>''));
