Report 50202 "Gate Pass RGP Shipment12"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Gate Pass RGP Shipment12.rdl';
    ...
    dataset
    {
        dataitem("RGP Shipment Header"; "SSD RGP Shipment Header")
        {
            ...
            column(Regus_Rectangle___Level_4___Rectangle_1___D_4__Saket_District_Centre___New_Delhi_110017___Phone__91_11_66544255Caption; R66544255CaptionLbl)
            {
            }
 ...
 if ItemRec.Get("RGP Shipment Line"."No.")then begin
            ...
            begin
                ...
                if not "RGP Shipment Header".NRGP then Heading:='RETURNABLE  GATE  PASS   (RGP)'
                else
    ...
    R66544255CaptionLbl: label 'Regus Rectangle | Level-4 | Rectangle 1 | D-4, Saket District Centre | New Delhi 110017 | Phone +91 11 66544255';
